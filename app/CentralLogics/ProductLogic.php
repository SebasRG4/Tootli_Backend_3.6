...
class ProductLogic
{
    ...
    public static function popular_products($zone_id, $limit = 25, $offset = 1, $type = 'all', $category_ids = null, $filter = null, $min = 0, $max = false, $rating_count = null, $search = null, $longitude = 0, $latitude = 0)
    {
