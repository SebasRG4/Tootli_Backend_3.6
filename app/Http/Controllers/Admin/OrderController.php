...
class OrderController extends Controller
{
    ...
    public function partial_delivery(Request $request, $id)
    {
        ...
        // Logic similar to DeliverymanController but triggered by Admin
        ...
        if ($minutes_items->count() > 0) {
            ...
            if ($pending_items > 0) {
                ...
                // Optionally create transaction or other logic here if needed

                $order->save();
                Toastr::success(translate('messages.minutes_items_marked_delivered'));
            } else {
                // If no pending items (unexpected in this flow but possible), mark fully delivered
            ...
            Toastr::info(translate('messages.no_pending_minutes_items_found'));
        }
