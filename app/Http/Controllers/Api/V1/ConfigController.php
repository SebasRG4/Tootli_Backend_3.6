...
class ConfigController extends Controller
{
    ...
    public function configuration()
    {
        $key = [
            ...
            'wallet_status',
            'wallet_cashback_status',
            'wallet_cashback_percentage',
            'dm_tips_status',
            'ref_earning_status',
        ...
        return response()->json([
            ...
            'wallet_cashback_status' => (int) (isset($settings['wallet_cashback_status']) ? $settings['wallet_cashback_status'] : 1),
            'wallet_cashback_percentage' => (float) (isset($settings['wallet_cashback_percentage']) ? $settings['wallet_cashback_percentage'] : 3.0),
