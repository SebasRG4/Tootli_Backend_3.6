...
class SaboresCiudadController extends Controller
{
    ...
    public function getStoresForMap(Request $request)
    {
        ...
        $stores = Store::withoutGlobalScope(\App\Scopes\ZoneScope::class)
            ...
            ->select('id', 'name', 'address', 'latitude', 'longitude', 'cover_photo', 'average_ticket', 'rating', 'delivery_time', 'google_address', 'google_place_id', 'serves_alcohol', 'cuisine_names', 'infrastructure_images', 'menu_images', 'accepts_reservations', 'featured', 'zone_id', 'module_id')
            ->with('activeCoupons')
