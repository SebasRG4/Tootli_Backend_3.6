...
class Zone extends Model
{
    ...
    {
        return $this->belongsToMany(Module::class)->withPivot(['per_km_shipping_charge', 'minimum_shipping_charge', 'maximum_shipping_charge', 'maximum_cod_order_amount', 'delivery_charge_type', 'fixed_shipping_charge', 'max_delivery_radius', 'td_delivery_charge_type', 'td_fixed_shipping_charge', 'td_per_km_shipping_charge', 'td_minimum_shipping_charge', 'td_maximum_shipping_charge', 'large_order_surcharge', 'free_shipping_enabled', 'free_shipping_threshold', 'store_shipping_contribution'])->using('App\Models\ModuleZone')->orderBy('modules.order', 'asc');
    }
