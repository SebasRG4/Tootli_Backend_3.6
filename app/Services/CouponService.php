...
class CouponService
{
    ...
    public function getAddData(object $request, int|string $moduleId): array
    {
        ...
        } else if ($request->coupon_type == 'store_wise' || $request->coupon_type == 'dineout') {
        ...
        return [
            ...
            'module_id' => $moduleId,
            'store_id' => is_array($data) && ($request->coupon_type == 'store_wise' || $request->coupon_type == 'dineout') ? $data[0] : null,
        ];
    }
