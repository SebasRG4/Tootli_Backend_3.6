<?php return array(
  ...
  'tootli_direct_pos_enabled' => 'Tootli Direct mode enabled: use menu prices, add customer and delivery address, then place order.',
  'tootli_direct_pos_disabled' => 'Classic POS mode: counter / takeaway flow.',
  'tootli_direct_pos_requires_address_and_customer' => 'Tootli Direct requires a delivery address and an internal store customer.',
  'pos_app_customer_disabled' => 'Registering app customers from the POS is disabled. Use internal customers only.',
  'pos_internal_customer_placeholder' => 'Walk-in or search internal customer',
  'pos_shell_my_order' => 'My order',
  'pos_shell_find_food' => 'Find the best food',
  'pos_shell_search_placeholder' => 'Search here',
  'tootli_direct_customer_pays_delivery' => 'Amount customer pays for delivery',
  'store_internal_customer' => 'Internal',
  'add_internal_customer' => 'Add internal customer',
  'internal_customer_added_successfully' => 'Internal customer saved for this store.',
  'internal_customer_found_by_phone' => 'A customer with this phone was already registered for this store. We selected them for you and updated the name if you changed it.',
  'internal_customer_help' => 'POS only uses internal customers (no app user directory). Unique phone per store.',
  'pos_payment_cash_on_delivery' => 'Cash (driver collects)',
  'pos_payment_card_on_delivery' => 'Card at door (UI only — not implemented)',
  'pos_payment_paid_at_restaurant' => 'Paid at restaurant (food); shipping settled with Tootli',
  ...
  'tootli_direct_pos_delivery_hint' => 'Tootli Direct: tap the pencil to set delivery address on the map, contact name/phone, then save. Select or add an internal store customer (not walk-in).',
  'pos_delivery_information' => 'Delivery information',
  'pos_contact_name' => 'Contact name',
  'pos_contact_phone' => 'Contact phone',
  'pos_road' => 'Street / road',
  'pos_house' => 'Number / house (optional)',
  'pos_floor' => 'Floor / unit (optional)',
  'pos_address_notes' => 'Address notes',
  'pos_longitude' => 'Longitude',
  'pos_latitude' => 'Latitude',
  'pos_map_pin_hint' => 'Place the pin on the map to calculate the delivery fee.',
  'pos_delivery_fee_label' => 'Delivery fee',
  'pos_save_delivery' => 'Save delivery address',
  'pos_search_location' => 'Search address on the map',
  'pos_placeholder_contact_name' => 'E.g. John Smith',
  'pos_placeholder_contact_phone' => 'E.g. +1 5551234567',
  'pos_placeholder_road' => 'E.g. Main Street',
  'pos_placeholder_house' => 'E.g. 45',
  'pos_placeholder_floor' => 'E.g. 3B',
  'pos_placeholder_address' => 'E.g. between streets, building, instructions for the driver',
  'tootli_direct_order_badge' => 'Tootli Direct',
