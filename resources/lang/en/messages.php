<?php return array (
  ...
  'ecartpay_gateway_report_title' => 'EcartPay: fees and admin net by payment method',
  'ecartpay_gateway_report_subtitle' => 'Totals for non-refunded transactions in this report: gateway fees (incl. VAT) and admin commission minus admin discount minus those fees.',
  'ecartpay_saved_card_heading' => 'Saved card',
  'ecartpay_spei_heading' => 'Bank transfer (SPEI)',
  'ecartpay_total_gateway_fees' => 'Total gateway fees',
  'ecartpay_admin_net_after_gateway' => 'Admin net after gateway fees',
  ...
  'tootli_direct_food_commission' => 'Tootli Direct — commission on food (%)',
  'tootli_direct_food_commission_hint' => 'Applied to order food amount when order_type is direct. Default 0%. Independent of store commission for app orders.',
  'tootli_direct_delivery_commission' => 'Tootli Direct — commission on delivery fee (%)',
  'tootli_direct_delivery_commission_hint' => 'Admin share of original_delivery_charge for direct orders. Rest goes to delivery flow as today.',
  'tootli_direct_menu_price' => 'Menu price (Tootli Direct)',
  'tootli_direct_menu_price_hint' => 'Price without app markup, for Tootli Direct orders. If empty, app unit price is used until you set this.',
  'app_unit_price_hint' => 'Price shown to customers in the app (often includes your commission margin).',
  ...
  'pos_delivery_information' => 'Delivery information',
  'pos_new_address' => 'New address',
  'pos_no_address_yet' => 'No address saved yet',
  ...
  'pos_paste_google_maps_link' => 'Google Maps link (WhatsApp, etc.)',
  'pos_apply_google_maps_link' => 'Apply link',
  'pos_google_maps_link_help' => 'Paste the https link the customer sent. Latitude, longitude and delivery fee update if the point is inside your coverage zone.',
  'invalid_maps_link' => 'This is not a valid Google Maps link.',
  'maps_link_resolve_failed' => 'Could not resolve the short link. Open it in a browser and copy the long URL from the address bar.',
  'maps_link_no_coordinates' => 'No coordinates found in that link. Use Share in Google Maps and paste the full link.',
  'maps_paste_link_empty' => 'Paste a Google Maps link first.',
  'pos_maps_link_map_not_ready' => 'Wait for the zone map to finish loading, then try again.',
  'tootli_direct_order_badge' => 'Tootli Directo',
  'tootli_direct_tracking_chat_closed' => 'This order’s chat is no longer available (order delivered).',
  'tootli_direct_chat_customer_message_title' => 'Tootli Direct — message from customer',
  ...
  'registration_revision_requested' => 'The delivery man can sign in again to update their registration with your message.',
  'request_registration_revision' => 'Request corrections',
  ...
  'dm_push_registration_approved_title' => 'Approved!',
  'dm_push_registration_approved_body' => 'You can start flying with Tootli.',
  'dm_push_registration_denied_title' => 'Registration not approved',
  'dm_push_registration_denied_body' => 'Your joining request was not approved. Contact support if you need more information.',
  'dm_push_registration_revision_title' => 'Action required on your registration',
  'Sent_notification_on_deliveryman_registration_revision_request' => 'Push when admin asks the delivery man to correct registration data',
...
',
  ...
  'deliveryman_registration_revision_request' => 'Delivery man registration correction request',
...
Smartly or Earn. ',
  ...
  'Multi_store_delivery_extra_title' => 'Extra charge for multi-store delivery',
  'Multi_store_delivery_extra_global_badge' => 'Applies to all zones',
  'Multi_store_delivery_extra_hint' => 'When enabled, each additional store in the same delivery order adds this amount to the delivery fee (first store unchanged). Prescription orders are excluded.',
  'Multi_store_delivery_extra_enable' => 'Enable extra per additional store',
  'Multi_store_delivery_extra_amount_label' => 'Amount per additional store',
  ...
  'order_cancel_reason_exempt_strike_review' => 'Skip strike review queue (deliveryman only)',
  'order_cancel_reason_exempt_strike_review_help' => 'When enabled, cancellations with this reason do not enqueue admin strike review (e.g. verified accident). Order is still cancelled and audit is logged.',
  'order_cancel_reason_strike_review_column' => 'Strike review',
  'Denial_Note' => 'Denial Note',
  ...
  'Map marker emoji (Sabores)' => 'Map marker emoji (Sabores)',
  'Automatic by cuisine or name' => 'Automatic (cuisine keywords or first letter of name)',
  'Shown on the city map pin for this restaurant.' => 'Shown on the city map pin for this restaurant.',
  ...
  'charge_multiplier' => 'Charge multiplier',
  'Option' => 'Option',
  ...
  'parcel_type_buy_and_deliver' => 'Buy and deliver',
  'parcel_type_pickup_and_deliver' => 'Pick up and deliver',
  ...
  'Add multiple physical locations for this store.' => 'Add multiple physical locations for this store.',
  ...
  'Error_saving_grid' => 'Error saving grid',
  'Saving...' => 'Saving...',
  'Eraser' => 'Eraser',
  'Minutes (Fast)' => 'Minutes (Fast)',
  'Grid updated successfully' => 'Grid updated successfully',
  'Configure_Delivery_Grid' => 'Configure Delivery Grid',
  'Configure Delivery Grid' => 'Configure Delivery Grid',
  'you_want_to_delete_this_location' => 'You want to delete this location',
  ...
  'Store Locations (Multi-location)' => 'Store Locations (Multi-location)',
  'select_reason' => 'Select reason',
  'delivery_type' => 'Delivery type',
  'deliver_minutes_items' => 'Deliver minutes items',
  'Dynamic Sections' => 'Dynamic Sections',
  'background_image' => 'Background image',
  'enter_subtitle' => 'Enter subtitle',
  'enter_title' => 'Enter title',
  'Dynamic Section Shop' => 'Dynamic Section Shop',
  'select_stores' => 'Select stores',
  'recommended_ratio_4_1' => 'Recommended ratio 4 1',
  'add_new_section' => 'Add new section',
  'dynamic_sections_ecommerce' => 'Dynamic sections ecommerce',
  'section_created_successfully' => 'Section created successfully',
  'section_updated_successfully' => 'Section updated successfully',
  'edit_section' => 'Edit section',
  'Payments / Services' => 'Payments / Services',
  'Pagos/Servicios' => 'Pagos/Servicios',
  'dynamic_pricing' => 'Dynamic pricing',
  'Algorithm Suggestions' => 'Algorithm Suggestions',
  'download_qr' => 'Download qr',
  'scan_this_qr_to_pay_to_this_store' => 'Scan this qr to pay to this store',
  'store_qr_code' => 'Store qr code',
  'edit_customer' => 'Edit customer',
  'this_code_will_be_displayed_in_the_app_for_this_user' => 'This code will be displayed in the app for this user',
  ...
  'home_screen_sections' => 'Home screen sections',
  'Promotional Banner' => 'Promotional Banner',
  'Promo Code Banner' => 'Promo Code Banner',
  'edit_dynamic_section' => 'Edit dynamic section',
  'show_title' => 'Show title',
  'New message received' => 'New message received',
  'admin_delivery_support_chat_title' => 'Driver ↔ Admin support chat',
  'admin_delivery_support_chat_menu' => 'Driver support chat',
  'browser_notification_new_message_title' => 'New chat message',
  'browser_notification_new_message_body' => 'Open the admin panel to read the conversation.',
  'new_message_arrived_toast' => 'New message arrived',
  'support_dm_cancel_tool_title' => 'Support: cancel order (audit)',
  'support_dm_cancel_tool_hint' => 'If you approve canceling the order from this driver chat, enter the order ID and confirm. The reason is stored in the order history.',
  'support_dm_cancel_confirm' => 'Cancel this order with the given reason? This action updates order status.',
  'support_dm_cancel_default_reason' => 'Cancellation approved by support (driver chat audit)',
  'support_dm_cancel_apply' => 'Apply cancellation',
  ...
  'dm_assignment_snapshot_title' => 'Order assignment (driver)',
  'dm_assignment_tier_label' => 'Tier',
  'dm_assignment_tier_pending' => 'Coming soon',
  'dm_assignment_max_concurrent' => 'Max concurrent orders (config)',
  'dm_assignment_current_orders' => 'Active orders count',
  'dm_assignment_cash_in_hand' => 'Cash in hand',
  'dm_assignment_max_cash' => 'Max cash in hand (setting)',
  'dm_assignment_admin_audit_title' => 'Suspension / activation audit (admin)',
  'dm_assignment_audit_when' => 'When',
  'dm_assignment_audit_action' => 'Action',
  'dm_assignment_audit_admin' => 'Admin',
  'dm_assignment_audit_action_suspend' => 'Account suspended',
  'dm_assignment_audit_action_unsuspend' => 'Account reactivated',
  'dm_assignment_concurrent_detail' => 'Global max :g · Tier cap :t',
  'dm_assignment_max_order_cod' => 'Max COD amount per order (tier)',
  'dm_assignment_audit_action_tier' => 'Tier / mode changed',
  'dm_tier_label_new' => 'New driver',
  'dm_tier_label_standard' => 'Standard',
  'dm_tier_label_pro' => 'Pro',
  'dm_tier_label_restricted' => 'Restricted',
  'dm_tier_source_auto' => 'Automatic tier',
  'dm_tier_source_manual' => 'Manual tier (nightly job will not change tier)',
  'dm_tier_source_field' => 'Tier mode',
  'dm_tier_reason_field' => 'Reason',
  'dm_tier_reason_placeholder' => 'e.g. probation, operational hold',
  'dm_tier_admin_form_title' => 'Adjust tier and automatic recalculation',
  'dm_tier_updated_title' => 'Driver level updated',
  'dm_tier_updated_body' => 'Your level is now :tier.',
  'dm_tier_restricted_cod_order_value' => 'This COD order exceeds the maximum amount allowed for your current driver level.',
  'dm_strike_temp_suspension' => 'Your account has a temporary strike-related suspension. You cannot accept orders until that time.',
  'dm_strike_weight_limit' => 'You have reached the strike weight limit for the current period. Contact support or wait for events to roll off.',
  'dm_strike_incident_types_title' => 'Incident types (strikes)',
  'dm_strike_incident_types_menu' => 'Incidents / strikes',
  'dm_strike_incident_type_add' => 'New incident type',
  'dm_strike_code' => 'Code',
  'dm_strike_weight' => 'Weight',
  'dm_strike_sort' => 'Sort order',
  'dm_strike_generates_strike' => 'Counts toward threshold',
  'dm_strike_appeals_title' => 'Pending strike appeals',
  'dm_strike_appeals_menu' => 'Strike appeals',
  'dm_strike_appeal_dm' => 'Driver',
  'dm_strike_type' => 'Type',
  'dm_strike_appeal_text' => 'Message',
  'dm_strike_appealed_at' => 'Appealed at',
  'dm_strike_appeal_accept' => 'Accept appeal',
  'dm_strike_appeal_reject' => 'Reject',
  'dm_strike_appeal_not_pending' => 'This appeal is no longer pending.',
  'dm_strike_type_invalid' => 'Invalid or inactive incident type.',
  'dm_strike_order_not_for_dm' => 'The order does not belong to this driver.',
  'dm_strike_panel_title' => 'Strikes and temporary suspension',
  'dm_strike_rolling_detail' => 'Rolling weight over :d days: :w (threshold :t)',
  'dm_strike_blocked_badge' => 'Blocked from new orders',
  'dm_strike_ok_badge' => 'Within threshold',
  'dm_strike_suspended_until_label' => 'Temporary suspension until',
  'dm_strike_suspension_form_title' => 'Temporary suspension (strikes only)',
  'dm_strike_suspended_until_field' => 'Suspend assignments until',
  'dm_strike_record_event_title' => 'Record incident / strike',
  'dm_assignment_audit_action_strike' => 'Strike / incident recorded',
  'dm_assignment_audit_action_strike_suspension' => 'Strike temporary suspension updated',
  'dm_assignment_audit_action_strike_appeal' => 'Strike appeal resolved',
  'dm_cancel_reason_required' => 'You must select a cancellation reason (cancel_reason_id).',
  'dm_cancel_reason_required_parcel' => 'Cancellation reason (reason) is required for parcel orders.',
  'dm_cancel_reason_invalid' => 'Invalid cancellation reason or not enabled for drivers.',
  'dm_cancel_reason_legacy' => 'Free text (no catalog id)',
  'dm_cancel_reason_unspecified' => 'Unspecified',
  'order_strike_review_queue_title' => 'Queue: driver cancellations → strike',
  'order_strike_review_queue_menu' => 'Strike review (cancels)',
  'order_strike_review_not_pending' => 'This item is no longer pending.',
  'order_strike_review_detail' => 'Detail',
  'order_strike_review_evidence' => 'Evidence',
  'order_strike_review_dismiss' => 'Dismiss (no strike)',
  'order_strike_review_record_strike' => 'Record strike',
  'order_strike_review_photos' => 'photo(s)',
  ...
  'kyc_status_updated_to' => 'Kyc status updated to',
  ...
  'Items You Love' => 'Items You Love',
  'Just For You' => 'Just For You',
  'Best Reviewed Items' => 'Best Reviewed Items',
  'Middle Section Banner' => 'Middle Section Banner',
