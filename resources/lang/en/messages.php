<?php return array(
  ...
  'tootli_direct_pos_requires_address_and_customer' => 'Tootli Direct requires a delivery address and a customer (app user or internal store customer).',
  ...
  'internal_customer_help' => 'For guests who are not registered in the app (e.g. phone/WhatsApp orders). Unique phone per store.',
  ...
  'tootli_direct_pos_delivery_hint' => 'Tootli Direct: tap the pencil to set delivery address on the map, contact name/phone, then save. Select an app customer from the list or add an internal customer (not walk-in).',
