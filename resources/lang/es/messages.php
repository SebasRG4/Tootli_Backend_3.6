<?php return array (
  ...
  'delete' => 'Eliminar',
  'Users' => 'Usuarios',
  'Transacciones y Reportes' => 'Transacciones y Reportes',
  ...
  'Configuración del Negocio' => 'Configuración del Negocio',
  'Terceros' => 'Terceros',
  'Redes Sociales y Páginas' => 'Redes Sociales y Páginas',
  'Ver todo' => 'Ver todo',
  'Gestión de Despachos' => 'Gestión de Despachos',
  'Sección de Módulos' => 'Sección de Módulos',
  'Select Module & Monitor your business module wise' => 'Select Module & Monitor your business module wise',
  'Añadir nuevo módulo' => 'Add new module',
  'Tutorial' => 'Tutorial',
  'Recorrido' => 'Recorrido',
  'Buscar menú...' => 'Buscar menú...',
  'panel de control' => 'Panel de Control',
  'employee_handle' => 'Manejo de empleados',
  ...
  'Reembolsos de pedidos' => 'Reembolsos de pedidos',
  'Solicitudes de reembolso' => 'Solicitudes de reembolso',
  ...
  'units' => 'Unidades',
  'Configuración de Productos' => 'Configuración de Productos',
  'add' => 'Añadir',
  'new' => 'Nuevo',
  'add_new' => 'Añadir nuevo',
  'list' => 'Lista',
  'review' => 'Reseña',
  'store' => 'Tienda/Restaurante',
  'management' => 'Gestión',
  'requests' => 'Solicitudes',
  'new_stores' => 'Nuevas tiendas',
  'stores' => 'Tiendas',
  'settings' => 'Configuración',
  'logout_warning_message' => '¿Estás seguro de que quieres cerrar sesión?',
  'yes' => 'Sí',
  ...
  'driver_missions' => 'Misiones de repartidores',
  'mission_list' => 'Lista de misiones',
  'add_mission' => 'Agregar misión',
  'edit_mission' => 'Editar misión',
  'mission_added_successfully' => 'Misión agregada exitosamente',
  'mission_updated_successfully' => 'Misión actualizada exitosamente',
  'mission_status_updated_successfully' => 'Estado de la misión actualizado exitosamente',
  'mission_deleted_successfully' => 'Misión eliminada exitosamente',
  'reviews' => 'Reseñas',
  ...
  'identity_images_two_sides_required' => 'Sube las dos caras de tu identificación (frente y reverso), mínimo dos fotos.',
  ...
  'ecartpay_gateway_report_title' => 'EcartPay: comisiones y ganancia neta admin por método de pago',
  'ecartpay_gateway_report_subtitle' => 'Totales de transacciones no reembolsadas en este reporte: comisión de pasarela (IVA incl.) y comisión admin menos descuento admin menos esa comisión.',
  'ecartpay_saved_card_heading' => 'Tarjeta guardada',
  'ecartpay_spei_heading' => 'Transferencia (SPEI)',
  'ecartpay_total_gateway_fees' => 'Comisión total pasarela',
  'ecartpay_admin_net_after_gateway' => 'Ganancia admin neta tras pasarela',
  ...
  'tootli_direct_food_commission' => 'Tootli Direct — comisión sobre comida (%)',
  'tootli_direct_food_commission_hint' => 'Se aplica al monto de comida cuando el pedido es tipo direct. Por defecto 0%. Independiente de la comisión de tienda en la app.',
  'tootli_direct_delivery_commission' => 'Tootli Direct — comisión sobre envío (%)',
  'tootli_direct_delivery_commission_hint' => 'Porcentaje admin sobre la tarifa base de envío (original_delivery_charge) en pedidos directos.',
  'tootli_direct_menu_price' => 'Precio menú (Tootli Direct)',
  'tootli_direct_menu_price_hint' => 'Precio sin markup de app, para pedidos Tootli Direct. Si está vacío, se usa el precio unitario de la app hasta que lo definas.',
  'app_unit_price_hint' => 'Precio que ve el cliente en la app (suele incluir margen/comisión).',
  'tootli_direct_pos_toggle' => 'Tootli Direct (POS)',
  'tootli_direct_pos_enabled' => 'Modo Tootli Direct: precios menú, cliente y dirección de entrega, luego confirma el pedido.',
  'tootli_direct_pos_disabled' => 'POS clásico: mostrador / para llevar.',
  'tootli_direct_pos_requires_address_and_customer' => 'Tootli Direct requiere dirección de entrega y un cliente interno de la tienda.',
  'pos_app_customer_disabled' => 'El alta de clientes de la app desde el POS está desactivada. Usa solo clientes internos.',
  'pos_internal_customer_placeholder' => 'Mostrador o buscar cliente interno',
  'pos_shell_my_order' => 'Mi pedido',
  'pos_shell_find_food' => 'Encuentra lo mejor',
  'pos_shell_search_placeholder' => 'Buscar aquí',
  'tootli_direct_customer_pays_delivery' => 'Envío que paga el cliente',
  'store_internal_customer' => 'Interno',
  'add_internal_customer' => 'Cliente interno',
  'internal_customer_added_successfully' => 'Cliente interno guardado para esta tienda.',
  'internal_customer_found_by_phone' => 'Ya había un cliente con ese teléfono en esta tienda. Lo seleccionamos automáticamente y actualizamos el nombre si lo cambiaste.',
  'internal_customer_help' => 'El POS solo usa clientes internos (sin directorio de usuarios de la app). El teléfono no se puede repetir en esta tienda.',
  'pos_payment_cash_on_delivery' => 'Efectivo (cobra el repartidor)',
  'pos_payment_card_on_delivery' => 'Tarjeta al entregar (solo pantalla — pendiente implementar)',
  'pos_payment_paid_at_restaurant' => 'Pagado en restaurante (comida); envío se liquida con Tootli',
  'invalid_payment_method' => 'Método de pago no válido para este pedido.',
  ...
  'Comer en restaurante' => 'Comer en restaurante',
  'Efectivo al repartidor' => 'Efectivo al repartidor',
  ...
  'pos_house' => 'Número / casa (opcional)',
  'pos_floor' => 'Piso o interior (opcional)',
  'pos_address_notes' => 'Referencias o indicaciones',
  'pos_longitude' => 'Longitud',
  'pos_latitude' => 'Latitud',
  'pos_map_pin_hint' => 'Coloca el pin en el mapa para calcular la tarifa de envío.',
  'pos_delivery_fee_label' => 'Tarifa de envío',
  'pos_save_delivery' => 'Guardar dirección de entrega',
  'pos_search_location' => 'Buscar dirección en el mapa',
  'pos_map_store_marker_title' => 'Tu restaurante — punto de partida del envío',
  'pos_map_store_reference_hint' => 'El mapa se centra en la ubicación de tu tienda (la misma que en Google Maps / ficha de tienda). Coloca el pin del cliente en el mapa o búscalo arriba.',
  'pos_placeholder_contact_name' => 'Ej: Juan Pérez',
  'pos_placeholder_contact_phone' => 'Ej: +52 5512345678',
  'pos_placeholder_road' => 'Ej: Av. Reforma',
  'pos_placeholder_house' => 'Ej: 45',
  'pos_placeholder_floor' => 'Ej: 3B',
  'pos_placeholder_address' => 'Ej: entre calles, edificio, indicaciones para el repartidor',
  'pos_paste_google_maps_link' => 'Enlace de Google Maps (WhatsApp, etc.)',
  'pos_apply_google_maps_link' => 'Usar enlace',
  'pos_google_maps_link_help' => 'Pega el enlace https que envió el cliente. Se rellenan latitud, longitud y la tarifa si el punto está dentro de tu zona de cobertura.',
  'invalid_maps_link' => 'El enlace no es un enlace válido de Google Maps.',
  'maps_link_resolve_failed' => 'No se pudo resolver el enlace corto. Abre el enlace en el navegador y copia la URL larga de la barra de direcciones.',
  'maps_link_no_coordinates' => 'No se encontraron coordenadas en ese enlace. Usa «Compartir» en Google Maps y pega el enlace completo.',
  ...
  'client' => 'Client',
  'server' => 'Server',
  'Social Login Setup' => 'Inicio de Sesión Social',
  'google' => 'Google',
  ...
  'total_withdrawal_amount' => 'Total Retirado',
  'withdraw_able_balance' => 'Saldo Disponible',
  ...
  'parcel_service_type' => 'Tipo de servicio',
  'parcel_type_buy_and_deliver' => 'Comprar y entregar',
  'parcel_type_pickup_and_deliver' => 'Recoger y entregar',
  'buy_and_deliver' => 'Comprar y entregar',
  'activate_if_you_want_to_buy_and_deliver' => 'Activa si el repartidor debe comprar el producto y entregarlo; desactivado = el cliente ya tiene el paquete (recoger y entregar)',
  ...
  'Is_It_Halal' => 'Marca Tootli',
  'halal_tag_status' => 'Marca Tootli status',
  'If_enabled,_customers_can_see_halal_tag_on_product' => 'If enabled  customers can see Marca Tootli on product',
  'Want_to_enable_halal_tag_status_for_this_store?' => 'Want to enable Marca Tootli status for this store ',
  'Want_to_disable_halal_tag_status_for_this_store?' => 'Want to disable Marca Tootli status for this store ',
  'If_disabled,_customers_can_not_see_halal_tag_on_product.' => 'If disabled  customers can not see Marca Tootli on product.',
  'Store_settings_updated!' => 'Store settings updated!',
  'Want_to_enable_halal_tag_status_for_this_restaurant?' => 'Want to enable Marca Tootli status for this restaurant ',
  'Want_to_disable_halal_tag_status_for_this_restaurant?' => 'Want to disable Marca Tootli status for this restaurant ',
  ...
  'registration_revision_requested' => 'El repartidor puede iniciar sesión de nuevo para actualizar su registro con tu mensaje.',
  'request_registration_revision' => 'Solicitar correcciones',
  ...
  'dm_push_registration_approved_title' => '¡Aprobado!',
  'dm_push_registration_approved_body' => 'Ya puedes empezar a volar con Tootli.',
  'dm_push_registration_denied_title' => 'Registro no aprobado',
  'dm_push_registration_denied_body' => 'Tu solicitud de ingreso no fue aprobada. Contacta soporte si necesitas más información.',
  'dm_push_registration_revision_title' => 'Acción requerida en tu registro',
  'Sent_notification_on_deliveryman_registration_revision_request' => 'Push cuando el admin pide corregir datos del registro',
...
',
  ...
  'deliveryman_registration_revision_request' => 'Solicitud de corrección de registro del repartidor',
...
Smartly or Earn. ',
  ...
  'Multi_store_delivery_extra_title' => 'Cargo extra por pedido multi-tienda',
  'Multi_store_delivery_extra_global_badge' => 'Aplica a todas las zonas',
  'Multi_store_delivery_extra_hint' => 'Si está activo, cada tienda adicional en el mismo pedido a domicilio suma este monto al envío (la primera tienda no suma extra). No aplica a pedidos con receta.',
  'Multi_store_delivery_extra_enable' => 'Activar cargo por tienda adicional',
  'Multi_store_delivery_extra_amount_label' => 'Monto por tienda adicional',
  ...
  'order_cancel_reason_exempt_strike_review' => 'Sin cola de revisión de strike (solo repartidor)',
  'order_cancel_reason_exempt_strike_review_help' => 'Si está activo, al cancelar con este motivo no se encola revisión para strike (p. ej. accidente verificado). El pedido se cancela igual y queda auditoría.',
  'order_cancel_reason_strike_review_column' => 'Revisión strike',
  'Denial_Note' => 'Denial Note',
  ...
  'Enable Surge Pricing' => 'Enable Surge Pricing',
  'Add Driver' => 'Add Driver',
  'User' => 'User',
  'Max Surge Multiplier' => 'Max Surge Multiplier',
  'Minimum Fare' => 'Minimum Fare',
  'Viajes' => 'Viajes',
  'Comida' => 'Comida',
  'Manita / Paquetería' => 'Manita / Paquetería',
  'Invalid delivery charge configuration for module:' => 'Invalid delivery charge configuration for module:',
  'Tiendas' => 'Tiendas',
  'Super Tootli' => 'Super Tootli',
  ...
  'Add Fare Configuration' => 'Add Fare Configuration',
  'Max Surge' => 'Max Surge',
  'Edit Fare Config' => 'Edit Fare Config',
  'Up to' => 'Up to',
  'Actions' => 'Actions',
  'Manage Drivers' => 'Manage Drivers',
  'Quick Actions' => 'Quick Actions',
  'Mark as Verified' => 'Mark as Verified',
  'Taxi Vehicles' => 'Taxi Vehicles',
  'Search by plate, brand, model' => 'Search by plate, brand, model',
  'All Types' => 'All Types',
  'Plate' => 'Plate',
  ...
  'Per Min' => 'Per Min',
  'Per KM' => 'Per KM',
  'Add Fare Config' => 'Add Fare Config',
  'Taxi Fare Configuration' => 'Taxi Fare Configuration',
  'Add Vehicle Type' => 'Add Vehicle Type',
  'fare_config_updated_successfully' => 'Fare config updated successfully',
  'Edit Vehicle Type' => 'Edit Vehicle Type',
  'Passengers' => 'Passengers',
  'Schedules' => 'Schedules',
  'Coming soon: Intercity schedules' => 'Coming soon: Intercity schedules',
  'Safety Reports' => 'Safety Reports',
  'Coming soon: Incident & safety reports' => 'Coming soon: Incident & safety reports',
  'Trip Tracking' => 'Trip Tracking',
  'Coming soon: Real-time trip tracking & monitoring' => 'Coming soon: Real-time trip tracking & monitoring',
  'Driver Verification' => 'Driver Verification',
  'Coming soon: Driver background verification' => 'Coming soon: Driver background verification',
  'SOS Alerts' => 'SOS Alerts',
  'Coming soon: Emergency SOS alerts management' => 'Coming soon: Emergency SOS alerts management',
  'Security & Safety' => 'Security & Safety',
  'Security' => 'Security',
  'Interurban Fares' => 'Interurban Fares',
  'Coming soon: Intercity fare configuration' => 'Coming soon: Intercity fare configuration',
  'Interurban Routes' => 'Interurban Routes',
  'Coming soon: Intercity travel routes' => 'Coming soon: Intercity travel routes',
  ...
  'The accepts reservations field must be true or false.' => 'The accepts reservations field must be true or false.',
  'Total Reservations' => 'Total Reservations',
  'Save Changes' => 'Save Changes',
  'Pending Reservations' => 'Pending Reservations',
  'View Reservations' => 'View Reservations',
  'You can select multiple images. Max 2MB per image.' => 'You can select multiple images. Max 2MB per image.',
  ...
  'services' => 'Services',
  'taxi_license_expiry' => 'Taxi license expiry',
  'Ex: 123456789' => 'Ex: 123456789',
  'taxi_license_number' => 'Taxi license number',
  ...
  'verify_taxi_service' => 'Verify taxi service',
  'driver_created_successfully' => 'Driver created successfully',
  'taxi_is_verified' => 'Taxi is verified',
  'Verify' => 'Verify',
  'Taxi Service Active' => 'Taxi Service Active',
  'Taxi Verified' => 'Taxi Verified',
  'Taxi License Number' => 'Taxi License Number',
  'Edit Driver' => 'Edit Driver',
  'Search Transaction ID or Type' => 'Search Transaction ID or Type',
  'Accepted by Driver' => 'Accepted by Driver',
  'No safety alerts found' => 'No safety alerts found',
  'Created' => 'Created',
  ...
  'Ride ID' => 'Ride ID',
  'Escalate' => 'Escalate',
  'Enter details about escalation...' => 'Enter details about escalation...',
  'Escalation Notes' => 'Escalation Notes',
  'This action indicates that the case has been reported to authorities.' => 'This action indicates that the case has been reported to authorities.',
  'Manage your restaurant reservations and discover the best dining experiences in your city.' => 'Manage your restaurant reservations and discover the best dining experiences in your city.',
  ...
  'Leave empty for all vehicle types' => 'Leave empty for all vehicle types',
  'Taxi Coupons' => 'Taxi Coupons',
  'Percentage' => 'Percentage',
  ...
  'Driver Verification Details' => 'Driver Verification Details',
  'Verification Details' => 'Verification Details',
  'Driver Information' => 'Driver Information',
  'Revoke Verification' => 'Revoke Verification',
  'Identity Side' => 'Identity Side',
  'Welcome to Sabores de la Ciudad' => 'Welcome to Sabores de la Ciudad',
  'Resolved' => 'Resolved',
  'Contacted' => 'Contacted',
  'Today\'s Alerts' => 'Today s Alerts',
  'Escalate to Authorities' => 'Escalate to Authorities',
  'Mark as Resolved' => 'Mark as Resolved',
  'Pending Alerts' => 'Pending Alerts',
  'Enter resolution details...' => 'Enter resolution details...',
  ...
  'Sabores de la Ciudad Settings' => 'Sabores de la Ciudad Settings',
  'Average cost per person' => 'Average cost per person',
  'e.g., 25.00' => 'E.g., 25.00',
  'Infrastructure Images' => 'Infrastructure Images',
  'Upload photos of restaurant interior, exterior, etc.' => 'Upload photos of restaurant interior, exterior, etc.',
  'e.g., 1600 Amphitheatre Parkway, Mountain View, CA' => 'E.g., 1600 Amphitheatre Parkway, Mountain View, CA',
  'Address from Google Maps' => 'Address from Google Maps',
  ...
  'Serves Alcohol' => 'Serves Alcohol',
  'Ex: Japanese, Asian' => 'Ex: Japanese, Asian',
  'Cuisine Names' => 'Cuisine Names',
  'restaurant_updated' => 'Restaurant updated',
  'Map marker emoji (Sabores)' => 'Emoji del pin en mapa (Sabores)',
  'Automatic by cuisine or name' => 'Automático (cocina o inicial del nombre)',
  'Shown on the city map pin for this restaurant.' => 'Se muestra en el pin del mapa de la ciudad para este restaurante.',
  'Total Restaurants' => 'Total Restaurants',
  'Type and hit Enter' => 'Type and hit Enter',
  'Maximum 3 tags allowed' => 'Maximum 3 tags allowed',
  'Failed to update image order' => 'Failed to update image order',
  'images_reordered_successfully' => 'Images reordered successfully',
  'Closing Time' => 'Closing Time',
  'Sabores de la Ciudad Dashboard' => 'Sabores de la Ciudad Dashboard',
  'Opening Time' => 'Opening Time',
  'Operating Hours' => 'Operating Hours',
  'Menu Images' => 'Menu Images',
  'dineout' => 'Dineout',
  'Add New' => 'Add New',
  'Dineout Categories' => 'Dineout Categories',
  'Want to delete this category?' => 'Want to delete this category?',
  'Assigned Stores' => 'Assigned Stores',
  'Remove' => 'Remove',
  'Want to remove this store?' => 'Want to remove this store?',
  'Assign Stores' => 'Assign Stores',
  'Average Ticket Cost' => 'Average Ticket Cost',
  'Extra information for the restaurant page.' => 'Extra information for the restaurant page.',
  'select_tags' => 'Select tags',
  'list_name_already_exists' => 'List name already exists',
  'list_created_successfully' => 'List created successfully',
  'list_not_found' => 'List not found',
  'list_deleted_successfully' => 'List deleted successfully',
  'store_already_in_list' => 'Store already in list',
  'store_added_to_list' => 'Store added to list',
  'store_not_in_list' => 'Store not in list',
  'store_removed_from_list' => 'Store removed from list',
  'reservations' => 'Reservations',
  'Valid Period' => 'Valid Period',
  'Item deleted' => 'Item deleted',
  'Search by Reviewer Name or Comment' => 'Search by Reviewer Name or Comment',
  'All Restaurants' => 'All Restaurants',
  'Blocked' => 'Blocked',
  'Edit Review' => 'Edit Review',
  'items_count' => 'Items count',
  'sections_list' => 'Sections list',
  'image_ratio_4:1' => 'Image ratio 4:1',
  'Campaigns' => 'Campaigns',
  'Add New Campaign' => 'Add New Campaign',
  'Sabores Campaigns' => 'Sabores Campaigns',
  'Top Restaurants' => 'Top Restaurants',
  'enter_radius_in_km' => 'Enter radius in km',
  'maximum_distance_for_restaurant_visibility' => 'Maximum distance for restaurant visibility',
  ...
  'dm_assignment_snapshot_title' => 'Asignación de pedidos (repartidor)',
  'dm_assignment_tier_label' => 'Nivel (tier)',
  'dm_assignment_tier_pending' => 'Próximamente',
  'dm_assignment_max_concurrent' => 'Máximo de pedidos concurrentes (config)',
  'dm_assignment_current_orders' => 'Pedidos activos actuales',
  'dm_assignment_cash_in_hand' => 'Efectivo en mano',
  'dm_assignment_max_cash' => 'Tope de efectivo en mano (ajuste)',
  'dm_assignment_admin_audit_title' => 'Auditoría suspensión / activación (admin)',
  'dm_assignment_audit_when' => 'Fecha',
  'dm_assignment_audit_action' => 'Acción',
  'dm_assignment_audit_admin' => 'Administrador',
  'dm_assignment_audit_action_suspend' => 'Cuenta suspendida',
  'dm_assignment_audit_action_unsuspend' => 'Cuenta reactivada',
  'dm_assignment_concurrent_detail' => 'Máx. global :g · Tope por nivel :t',
  'dm_assignment_max_order_cod' => 'Monto máx. COD por pedido (nivel)',
  'dm_assignment_audit_action_tier' => 'Cambio de nivel / modo',
  'dm_tier_label_new' => 'Nuevo',
  'dm_tier_label_standard' => 'Estándar',
  'dm_tier_label_pro' => 'Pro',
  'dm_tier_label_restricted' => 'Restringido',
  'dm_tier_source_auto' => 'Nivel automático',
  'dm_tier_source_manual' => 'Nivel manual (el job nocturno no lo cambia)',
  'dm_tier_source_field' => 'Modo de nivel',
  'dm_tier_reason_field' => 'Motivo',
  'dm_tier_reason_placeholder' => 'ej. periodo de prueba, retención operativa',
  'dm_tier_admin_form_title' => 'Ajustar nivel y recálculo automático',
  'dm_tier_updated_title' => 'Nivel de repartidor actualizado',
  'dm_tier_updated_body' => 'Tu nivel ahora es :tier.',
  'dm_tier_restricted_cod_order_value' => 'Este pedido COD supera el monto máximo permitido para tu nivel actual.',
  'dm_strike_temp_suspension' => 'Tu cuenta tiene una suspensión temporal por incidencias. No puedes aceptar pedidos hasta la fecha indicada.',
  'dm_strike_weight_limit' => 'Has alcanzado el límite de strikes en el periodo actual. Contacta a soporte o espera a que venzan los registros.',
  'dm_strike_incident_types_title' => 'Tipos de incidencia (strikes)',
  'dm_strike_incident_types_menu' => 'Incidencias / strikes',
  'dm_strike_incident_type_add' => 'Nuevo tipo de incidencia',
  'dm_strike_code' => 'Código',
  'dm_strike_weight' => 'Peso',
  'dm_strike_sort' => 'Orden',
  'dm_strike_generates_strike' => 'Cuenta para el umbral',
  'dm_strike_appeals_title' => 'Apelaciones de strikes pendientes',
  'dm_strike_appeals_menu' => 'Apelaciones strikes',
  'dm_strike_appeal_dm' => 'Repartidor',
  'dm_strike_type' => 'Tipo',
  'dm_strike_appeal_text' => 'Mensaje',
  'dm_strike_appealed_at' => 'Apelado',
  'dm_strike_appeal_accept' => 'Aceptar apelación',
  'dm_strike_appeal_reject' => 'Rechazar',
  'dm_strike_appeal_not_pending' => 'Esta apelación ya no está pendiente.',
  'dm_strike_type_invalid' => 'Tipo de incidencia no válido o inactivo.',
  'dm_strike_order_not_for_dm' => 'El pedido no corresponde a este repartidor.',
  'dm_strike_panel_title' => 'Strikes y suspensión temporal',
  'dm_strike_rolling_detail' => 'Peso acumulado en :d días: :w (umbral :t)',
  'dm_strike_blocked_badge' => 'Bloqueado para nuevos pedidos',
  'dm_strike_ok_badge' => 'Dentro del umbral',
  'dm_strike_suspended_until_label' => 'Suspensión temporal hasta',
  'dm_strike_suspension_form_title' => 'Suspensión temporal (solo strikes)',
  'dm_strike_suspended_until_field' => 'Suspender asignaciones hasta',
  'dm_strike_record_event_title' => 'Registrar incidencia / strike',
  'dm_assignment_audit_action_strike' => 'Strike / incidencia registrada',
  'dm_assignment_audit_action_strike_suspension' => 'Suspensión temporal por strikes actualizada',
  'dm_assignment_audit_action_strike_appeal' => 'Apelación de strike resuelta',
  'dm_cancel_reason_required' => 'Debes elegir un motivo de cancelación (cancel_reason_id).',
  'dm_cancel_reason_required_parcel' => 'El motivo de cancelación (reason) es obligatorio para paquetería.',
  'dm_cancel_reason_invalid' => 'Motivo de cancelación no válido o no habilitado para repartidor.',
  'dm_cancel_reason_legacy' => 'Texto libre (sin catálogo)',
  'dm_cancel_reason_unspecified' => 'Sin especificar',
  'admin_delivery_support_chat_title' => 'Chat soporte repartidor ↔ administración',
  'admin_delivery_support_chat_menu' => 'Chat soporte repartidores',
  'browser_notification_new_message_title' => 'Nuevo mensaje en el chat',
  'browser_notification_new_message_body' => 'Abre el panel de administración para ver la conversación.',
  'new_message_arrived_toast' => 'Nuevo mensaje recibido',
  'support_dm_cancel_tool_title' => 'Soporte: cancelar pedido (auditoría)',
  'support_dm_cancel_tool_hint' => 'Si apruebas la cancelación desde este chat con el repartidor, indica el ID del pedido y confirma. El motivo queda en el historial del pedido.',
  'support_dm_cancel_confirm' => '¿Cancelar este pedido con el motivo indicado? Se actualizará el estado del pedido.',
  'support_dm_cancel_default_reason' => 'Cancelación aprobada por soporte (auditoría en chat con repartidor)',
  'support_dm_cancel_apply' => 'Aplicar cancelación',
  'New message received' => 'Nuevo mensaje recibido',
  'order_strike_review_queue_title' => 'Cola: cancelaciones repartidor → strike',
  'order_strike_review_queue_menu' => 'Revisión strikes (cancel.)',
  'order_strike_review_not_pending' => 'Este caso ya no está pendiente.',
  'order_strike_review_detail' => 'Detalle',
  'order_strike_review_evidence' => 'Evidencia',
  'order_strike_review_dismiss' => 'Sin strike',
  'order_strike_review_record_strike' => 'Registrar strike',
  'order_strike_review_photos' => 'foto(s)',
  'order_strike_review_audio' => 'Audio',
  ...
  'dashboard' => 'Dashboard',
  'mins' => 'Mins',
  'another_store_item_already_exists' => 'No puedes agregar productos de una tienda diferente al carrito.',
  'multi_store_not_allowed' => 'No se permite pedir de varias tiendas en un mismo pedido.',
  ...
  'License must not be expired' => 'License must not be expired',
  ...
  'partial_delivery_successful_driver_released' => 'Partial delivery successful driver released',
  ...
  'wait_for_store_to_mark_ready' => 'Wait for store to mark ready',
  'dm_order_exceeds_tier_cod_limit' => 'Dm order exceeds tier cod limit',
  'Incentivized_Order_Alert' => 'Incentivized Order Alert',
  'A pending order has a pay boost! Accept it now.' => 'A pending order has a pay boost! Accept it now.',
  'Pay_Boost_Level_1' => 'Pay Boost Level 1',
  'now pays better!' => 'Now pays better!',
  'Maximum_Incentive_Alert' => 'Maximum Incentive Alert',
  'has an extra bonus! Accept it fast.' => 'Has an extra bonus! Accept it fast.',
