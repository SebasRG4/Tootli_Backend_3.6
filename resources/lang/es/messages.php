<?php return array(
  ...
  'tootli_direct_pos_requires_address_and_customer' => 'Tootli Direct requiere dirección de entrega y un cliente (usuario de la app o cliente interno de la tienda).',
  ...
  'internal_customer_help' => 'Para comensales sin cuenta en la app (pedidos por teléfono/WhatsApp, etc.). El teléfono no se puede repetir en esta tienda.',
  ...
  'tootli_direct_pos_delivery_hint' => 'Tootli Direct: toca el lápiz, coloca el pin en el mapa, nombre y teléfono de contacto, y guarda. Elige un cliente de la app o crea un cliente interno (no uses solo “walk-in”).',
