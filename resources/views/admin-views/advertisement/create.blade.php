                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="js-nav-scroller hs-nav-scroller-horizontal">
                                <ul class="nav nav-tabs mb-3 border-0">
                                    ...
                                    @if ($language)
                                        ...
                                        <div class="lang_form" id="default-form">
                                            ...
                                            <div class="mb-20">
                                                <label class="form-label">{{ 'Título del anuncio' }}
                                                    ({{ 'Por defecto' }})</label>
                                                <input type="text" class="form-control" id="title" name="title[]"
                                                    value="{{ old('title.0') }}" placeholder="{{ 'Oferta exclusiva' }}"
                                                    maxlength="255" data-preview-text="preview-title">
                                            </div>
                                            <div class="form-floating mb-20">
                                                <label class="form-label">{{ 'Breve descripción' }}
                                                    ({{ 'Por defecto' }})</label>
                                ...
                                <div class="mb-20">
                                    <label class="input-label" for="store_id">{{ 'seleccionar tienda' }} <span
                                            class="form-label-secondary" data-toggle="tooltip" data-placement="right"
                                            data-original-title="{{ 'Si desea crear un anuncio en vídeo, puede omitir este campo.' }}"><img
                            ...
                            <label class="form-label"
                                for="exampleFormControlSelect1">{{ 'Seleccionar tienda' }} </label>
                            <div class="mb-20">
                            ...
                            <div class="promotion-typewise-upload-box" id="profile-upload-box">
                                ...
                                <div
                                    ...
                                    <div class="d-flex flex-column align-items-center gap-3 flex-shrink-0">
                                        <p class="title-color mb-0">{{ 'Imagen de perfil' }} <span
                                                class="text-danger">({{ 'Relación - 1:1' }})</span></p>
                                    ...
                                    <div class="d-flex flex-column align-items-center gap-3">
                                        <p class="title-color mb-0">{{ 'Subir portada' }} <span
                                                class="text-danger">({{ 'Relación - 2:1' }})</span></p>
                                        <div class="upload-file">
                                            <input type="file" class="cover_attachment js-upload-input"
                                                        ...
                                                        <div class="rating-text static-text">
                                                            <div class="rating-number d-flex align-items-center">
                                                                <i class="tio-star"></i><span
                                                                    id="rating_data">{{ '4.7' }}</span>
                                                            </div>
                                                        </div>
                                                        <span id="review_data"
                                                            class="review--text static-text">({{ '25+' }})</span>
                                                    </div>
