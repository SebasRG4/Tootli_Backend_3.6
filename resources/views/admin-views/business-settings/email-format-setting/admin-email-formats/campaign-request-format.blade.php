                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Recibir correo sobre \'Solicitud de unirse a campaña\'?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si una tienda solicita unirse a la campaña, se enviará un correo electrónico automático al administrador.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                        ...
                                        data-title-on="{{'¿Quiere habilitar el correo de solicitud de campaña?'}}"
                                        data-title-off="{{'¿Quiere desactivar el correo de solicitud de campaña?'}}"
                                        data-text-on="<p>{{'Si está habilitado, el administrador recibirá un correo electrónico cuando una tienda solicite unirse a una campaña.'}}</p>"
                                        data-text-off="<p>{{'Si está deshabilitado, el administrador no recibirá correo cuando una tienda solicite unirse a una campaña.'}}</p>"
                                        ...
                                        <div class="__bg-F8F9FC-card">
                                            <div class="row g-3">
                                                <div class="col-sm-6">
                                                    @if ($language)
                                                        <div class="form-group m-0 lang_form default-form">
                                                            ...
                                                            <input type="text" data-id="mail-button" name="button_name[]"  placeholder="{{'Ej: Ordene ahora'}}" class="form-control h--45px" value="{{ $data?->getRawOriginal('button_name') }}">
                                                        </div>
                                                    @foreach(json_decode($language) as $lang)
                                                    <?php
                                                    if($data && count($data['translations'])){
                                                        ...
                                                        <div class="form-group m-0 d-none lang_form" id="{{$lang}}-form1">
                                                            ...
                                                            <input type="text" name="button_name[]"  placeholder="{{'Ej: Ordene ahora'}}" class="form-control h--45px" value="{{ $translate[$lang]['button_name']??'' }}">
                                                        </div>
                                                    @endforeach
                                                @else
                                                <div class="form-group m-0">
                                                    ...
                                                    <input type="text" placeholder="{{'Ej: Ordene ahora'}}" class="form-control h--45px" name="button_name[]" value="">
                                                </div>
                                                @endif
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group m-0">
                                                        ...
                                                        <input type="text" name="button_url" placeholder="{{ 'Por favor contáctenos para cualquier consulta; Siempre estaremos felices de ayudar.' }}"class="form-control" value="{{ $data['button_url']??'' }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
