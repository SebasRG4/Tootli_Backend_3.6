                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Recibir correo sobre el \'Registro de nuevo repartidor\'?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si Deliveryman se registra desde la aplicación, el sitio web o la aplicación Deliveryman del cliente, el administrador recibirá un correo electrónico automatizado.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="{{'¿Quieres habilitar el correo de registro del repartidor?'}}"
                                       data-title-off="{{'¿Quiere desactivar el correo de registro del repartidor?'}}"
                                       data-text-on="<p>{{'Si está habilitado, el administrador recibirá un correo electrónico automático cuando un repartidor se registre.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, el administrador no recibirá un correo electrónico automático cuando un repartidor se registre.'}}</p>"
