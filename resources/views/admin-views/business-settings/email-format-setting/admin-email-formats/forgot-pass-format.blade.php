                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                ...
                                <span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si un usuario hace clic en "Olvidé mi contraseña" durante el inicio de sesión, se enviará un correo electrónico automático al administrador.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                        ...
                                        data-text-on="<p>{{'Si está habilitado, el administrador recibirá un correo electrónico cuando un usuario haga clic en "Olvidé mi contraseña".'}}</p>"
                                        data-text-off="<p>{{'Si está deshabilitado, el administrador no recibirá un correo electrónico cuando un usuario haga clic en "Olvidé mi contraseña".'}}</p>"
