                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Recibir notificación de inicio de sesión por correo?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si un usuario inicia sesión desde su sistema respectivo, el administrador recibe una notificación por correo electrónico.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="{{'¿Quieres habilitar el correo de inicio de sesión?'}}"
                                       data-title-off="{{'¿Quieres desactivar el correo de inicio de sesión?'}}"
                                       data-text-on="<p>{{'Si está habilitado, el administrador recibirá un correo electrónico automático cada vez que inicien sesión todos los usuarios.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, el administrador no recibirá un correo electrónico automático cada vez que los usuarios inicien sesión.'}}</p>"
