                    ...
                    <div class="card-body">
                        <div class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'Recibir correo sobre \'Solicitud de nuevo anuncio\''}}
                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si una tienda agrega una adversidad, el administrador recibirá un correo electrónico automático con la Solicitud de nueva publicidad.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="{{'¿Quiere habilitar la solicitud de nuevo anuncio?'}}"
                                       data-title-off="{{'¿Quiere desactivar la solicitud de nuevo anuncio?'}}"
                                       data-text-on="<p>{{'Si está habilitado, el administrador recibirá un correo electrónico automatizado sobre la Solicitud de nuevo anuncio.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, el administrador no recibirá un correo electrónico automático sobre la Solicitud de nuevo anuncio.'}}</p>"
