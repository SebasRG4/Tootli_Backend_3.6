                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Recibir correo sobre \'Solicitud de reembolso\'?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si un cliente solicita un reembolso, el administrador recibirá un correo electrónico automático con la Solicitud de reembolso del cliente.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="{{'¿Quiere habilitar el correo de solicitud de reembolso?'}}"
                                       data-title-off="{{'¿Quiere desactivar el correo de solicitud de reembolso?'}}"
                                       data-text-on="<p>{{'Si está habilitado, el administrador recibirá un correo electrónico cuando un cliente solicite un reembolso desde la aplicación o el sitio web del cliente.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, el administrador no recibirá un correo electrónico cuando un cliente solicite un reembolso desde la aplicación o el sitio web del cliente.'}}</p>"
