                    ...
                    <div class="card-body">
                        <div class="maintenancemode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Recibir correo sobre \'Registro de nueva tienda\'?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si una tienda se registra desde el sitio web o la aplicación del cliente o la aplicación de la tienda, el administrador recibirá un correo electrónico automático.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="{{'¿Quieres habilitar el correo de registro de tienda?'}}"
                                       data-title-off="{{'¿Quiere desactivar el correo de registro de la tienda?'}}"
                                       data-text-on="<p>{{'Si está habilitado, el administrador recibirá un correo electrónico automático cuando una tienda se registre.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, el administrador no recibirá un correo electrónico automático cuando una tienda se registre.'}}</p>"
