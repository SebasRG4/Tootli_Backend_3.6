            ...
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si una tienda solicita un retiro, el administrador recibirá un correo electrónico automático.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-text-on="<p>{{'Si está habilitado, el administrador recibirá un correo electrónico cuando una tienda solicite un retiro.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, el administrador no recibirá un correo electrónico cuando una tienda solicite un retiro.'}}</p>"
