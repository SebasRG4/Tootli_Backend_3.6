                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'Enviar correo contra reembolso ¿El hombre lo aprueba?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si el administrador acepta el autorregistro de un repartidor, el repartidor recibirá un correo de aprobación automática.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="{{'¿Quieres habilitar el correo de aprobación del repartidor?'}}"
                                       data-title-off="{{'¿Quiere desactivar el correo de aprobación del repartidor?'}}"
                                       data-text-on="<p>{{'Si está habilitado, los repartidores recibirán un correo electrónico de confirmación cuando el administrador apruebe el registro.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, los repartidores no recibirán un correo electrónico de aprobación de registro.'}}</p>"
