                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Enviar correo sobre \'Cobro de efectivo\'?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si el administrador o la tienda cobra efectivo de un repartidor, recibirá un correo electrónico automatizado del sistema que le mostrará cuánto efectivo se cobra.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="{{'¿Quiere habilitar el correo con cobro en efectivo?'}}"
                                       data-title-off="{{'¿Quiere desactivar el correo con cobro en efectivo?'}}"
                                       data-text-on="<p>{{'Si está habilitado, el repartidor recibirá un correo electrónico después de que el administrador/tienda le recoja el efectivo.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, el repartidor no recibirá ningún correo electrónico sobre el cobro de efectivo.'}}</p>"
