                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Enviar correo sobre "Olvidé mi contraseña"?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si un repartidor toca "Olvidé mi contraseña" durante el inicio de sesión, se enviará un correo electrónico automático desde el sistema con un enlace para restablecer la contraseña.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="{{'¿Quieres habilitar el correo de Olvidar Contraseña?'}}"
                                       data-title-off="{{'¿Quieres desactivar el correo de Olvidar contraseña?'}}"
                                       data-text-on="<p>{{'Si está habilitado, el repartidor recibirá un correo electrónico automático con un enlace para restablecer la contraseña.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, el repartidor no recibirá ninguna información para restablecer la contraseña.'}}</p>"
