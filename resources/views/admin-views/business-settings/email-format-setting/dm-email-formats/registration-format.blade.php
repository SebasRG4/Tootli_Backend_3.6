                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Enviar correo sobre el registro de nuevo repartidor?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si un repartidor se registra desde la aplicación del cliente o el sitio web, la página de inicio del administrador o la aplicación de la tienda, recibirá un correo electrónico de confirmación de registro.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-text-on="<p>{{'Si está habilitado, los repartidores recibirán un correo automatizado del sistema cuando su registro sea exitoso.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, los repartidores no recibirán ningún correo electrónico de confirmación de registro.'}}</p>"
