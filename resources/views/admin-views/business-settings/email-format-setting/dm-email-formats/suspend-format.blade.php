                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Enviar correo sobre la \'suspensión de cuenta\' del repartidor?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si la tienda/administrador lo desea, puede suspender la cuenta de un repartidor. Si una Tienda o Administrador suspende la cuenta de un Repartidor, este recibirá un correo electrónico automático.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-text-on="<p>{{'Si está habilitado, los repartidores recibirán un correo electrónico para suspender la cuenta.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, los repartidores no recibirán un correo electrónico para suspender la cuenta.'}}</p>"
