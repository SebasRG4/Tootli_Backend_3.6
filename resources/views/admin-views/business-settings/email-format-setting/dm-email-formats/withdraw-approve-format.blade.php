                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Enviar correo al retirar aprobar?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si un repartidor solicita un retiro y el administrador lo aprueba, el repartidor recibirá un correo electrónico automático de aprobación de retiro del sistema.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="{{'¿Quieres habilitar Retirar correo aprobado?'}}"
                                       data-title-off="{{'¿Quieres desactivar Retirar correo aprobado?'}}"
                                       data-text-on="<p>{{'Si está habilitado, los repartidores recibirán un correo de aprobación para solicitar un retiro.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, los repartidores no recibirán ningún correo de aprobación de retiro.'}}</p>"
