                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Enviar correo sobre "Rechazo de retiro"?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si un repartidor solicita un retiro y el administrador lo rechaza, el repartidor recibirá un correo electrónico automático de rechazo de retiro del sistema.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="{{'¿Quieres habilitar Retirar correo denegado?'}}"
                                       data-title-off="{{'¿Quieres desactivar Retirar correo denegado?'}}"
                                       data-text-on="<p>{{'Si está habilitado, los repartidores recibirán un correo automático del sistema cuando el administrador rechace su solicitud de retiro.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, los repartidores no recibirán ningún correo de rechazo de retiro.'}}</p>"
