    ...
    <ul class="page-links-checkgrp">
        <li>
            <label class="form-check form--check">
                ...
                <span class="form-check-label">{{'política de privacidad'}}</span>
            </label>
        </li>
        <li>
            <label class="form-check form--check">
                ...
                <span class="form-check-label">{{'Política de reembolso'}}</span>
            </label>
        </li>
        <li>
            <label class="form-check form--check">
                ...
                <span class="form-check-label">{{'Política de Cancelación'}}</span>
            </label>
        </li>
        <li>
            <label class="form-check form--check">
                ...
                <span class="form-check-label">{{'Contáctenos'}}</span>
            </label>
        </li>
    </ul>
</div>
    ...
    <ul class="page-links-checkgrp">
        ...
        <li>
            <label class="form-check form--check">
                ...
                <span class="form-check-label">{{'Gorjeo'}}</span>
            </label>
        </li>
        <li>
            <label class="form-check form--check">
                ...
                <span class="form-check-label">{{'LinkedIn'}}</span>
            </label>
        </li>
        <li>
            <label class="form-check form--check">
                ...
                <span class="form-check-label">{{'Pinterest'}}</span>
            </label>
        </li>
    </ul>
</div>
