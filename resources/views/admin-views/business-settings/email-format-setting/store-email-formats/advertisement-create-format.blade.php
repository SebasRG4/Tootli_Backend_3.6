                    ...
                    <div class="card-body">
                        <div class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'Enviar correo al crear anuncio'}}
                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Las tiendas recibirán un correo de creación de publicidad.'}}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                data-title-on="{{'¿Quiere habilitar la creación de anuncios por correo?'}}"
                                data-title-off="{{'¿Quiere desactivar la creación de correo publicitario?'}}"
                                data-text-on="<p>{{'Si está habilitado, las tiendas recibirán un correo de creación de publicidad.'}}</p>"
                                data-text-off="<p>{{'Si está deshabilitado, las tiendas no recibirán un correo de creación de publicidad.'}}</p>"
