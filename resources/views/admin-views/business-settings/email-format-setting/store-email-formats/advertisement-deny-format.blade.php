                    ...
                    <div class="card-body">
                        <div class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'Enviar correo en anuncio rechazado'}}
                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Las tiendas recibirán correo cuando se rechace el anuncio.'}}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                data-title-on="{{'¿Quiere habilitar el correo de denegación de publicidad?'}}"
                                data-title-off="{{'¿Quiere desactivar el correo de denegación de publicidad?'}}"
                                data-text-on="<p>{{'Si está habilitado, las tiendas recibirán correo cuando se niegue la publicidad.'}}</p>"
                                data-text-off="<p>{{'Si está deshabilitado, las tiendas no recibirán un correo electrónico sobre el rechazo del anuncio.'}}</p>"
