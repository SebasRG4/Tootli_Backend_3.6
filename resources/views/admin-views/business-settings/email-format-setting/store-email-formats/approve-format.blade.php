                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Enviar correo sobre la aprobación de una nueva tienda?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si el administrador acepta el autorregistro de una tienda, la tienda recibirá un correo de aprobación automática del sistema.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="{{'¿Quieres habilitar el correo de aprobación de la tienda?'}}"
                                       data-title-off="{{'¿Quieres desactivar el correo de aprobación de la tienda?'}}"
                                       data-text-on="<p>{{'Si está habilitado, los usuarios recibirán un correo electrónico de confirmación cuando el administrador apruebe el registro.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, los usuarios no recibirán un correo electrónico de aprobación de registro.'}}</p>"
