                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Enviar correo sobre "Aprobación de participación en campaña"?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si una tienda solicita unirse a una campaña y el administrador aprueba su solicitud de unirse, recibe un correo electrónico de aprobación automatizado del sistema.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="{{'¿Quiere habilitar el correo de aprobación de campaña?'}}"
                                       data-title-off="{{'¿Quiere desactivar el correo de aprobación de campaña?'}}"
                                       data-text-on="<p>{{'Si está habilitado, las tiendas recibirán un correo electrónico cuando el administrador apruebe su solicitud de unirse a la campaña.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, las tiendas no recibirán un correo electrónico cuando el administrador apruebe su solicitud de unirse a la campaña.'}}</p>"
