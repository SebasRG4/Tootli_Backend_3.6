                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Enviar correo en solicitud de campaña?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si una Tienda solicita unirse a una campaña, recibirá un correo automático para que el registro se realice correctamente.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-text-on="<p>{{'Si está habilitado, las tiendas recibirán un correo electrónico de confirmación automatizado de que su solicitud de inscripción fue exitosa.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, las tiendas no recibirán ningún correo de confirmación sobre la solicitud de unirse a la campaña.'}}</p>"
