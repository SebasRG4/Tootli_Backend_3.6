                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Enviar correo sobre la aprobación del producto?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si el administrador aprueba el producto de una tienda, la tienda recibirá un correo de desaprobación automática del sistema.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="{{'¿Quiere habilitar el correo de aprobación de productos?'}}"
                                       data-title-off="{{'¿Quiere desactivar el correo electrónico de aprobación de productos?'}}"
                                       data-text-on="<p>{{'Si está habilitado, las tiendas recibirán un correo electrónico de confirmación cuando el administrador apruebe su producto.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, las tiendas no recibirán un correo de aprobación del producto.'}}</p>"
