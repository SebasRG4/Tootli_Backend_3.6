                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Enviar correo sobre producto denegado?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si el administrador rechaza el producto de una tienda, la tienda recibirá un correo de desaprobación automática del sistema.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                data-title-on="{{'¿Quieres habilitar el correo de denegación de productos de la tienda?'}}"
                                data-title-off="{{'¿Quiere desactivar el correo de denegación de productos de la tienda?'}}"
                                data-text-on="<p>{{'Si está habilitado, las tiendas recibirán un correo electrónico de confirmación cuando el administrador rechace su producto.'}}</p>"
                                data-text-off="<p>{{'Si está deshabilitado, las tiendas no recibirán un correo de rechazo de producto.'}}</p>"
