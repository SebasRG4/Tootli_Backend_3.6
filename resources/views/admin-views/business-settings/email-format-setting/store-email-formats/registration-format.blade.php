                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Enviar correo al registrarse en la tienda?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si una Tienda se registra desde la aplicación del Cliente o el Sitio web, la Página de inicio del administrador o la aplicación de la Tienda, recibirá un correo electrónico de confirmación.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-text-on="<p>{{'Si está habilitado, las tiendas recibirán un correo electrónico de confirmación de registro cuando se registren.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, las tiendas no recibirán un correo electrónico de confirmación de registro cuando una tienda se registre.'}}</p>"
