                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Enviar correo sobre advertencia de fecha límite de suscripción?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Las tiendas suscritas recibirán un correo recordatorio cuando su suscripción esté a punto de finalizar.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="{{'¿Quiere habilitar el correo electrónico de recordatorio de la fecha límite de suscripción?'}}"
                                       data-title-off="{{'¿Quiere desactivar el correo de recordatorio de la fecha límite de suscripción?'}}"
                                       data-text-on="<p>{{'Si está habilitado, las tiendas suscritas recibirán un correo recordatorio cuando su suscripción esté a punto de finalizar.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, las tiendas suscritas no recibirán un correo recordatorio cuando su suscripción esté a punto de finalizar.'}}</p>"
