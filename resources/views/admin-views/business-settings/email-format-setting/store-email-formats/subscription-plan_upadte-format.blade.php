                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Enviar correo sobre la actualización del plan de suscripción?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Las tiendas suscritas recibirán un correo electrónico cuando se actualice el plan de suscripción.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="{{'¿Quiere habilitar el correo de actualización del plan de suscripción?'}}"
                                       data-title-off="{{'¿Quiere desactivar el correo de actualización del plan de suscripción?'}}"
                                       data-text-on="<p>{{'Si está habilitado, las tiendas recibirán un correo electrónico de actualización del plan de suscripción cuando se actualice el plan.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, las tiendas no recibirán un correo electrónico de actualización del plan de suscripción cuando se actualice el plan.'}}</p>"
