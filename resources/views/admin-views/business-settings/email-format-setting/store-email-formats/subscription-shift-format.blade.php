                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Enviar correo en turno de suscripción?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si una tienda cambia exitosamente a un plan, recibirá un correo electrónico de confirmación.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="{{'¿Quiere habilitar el correo de turnos de suscripción?'}}"
                                       data-title-off="{{'¿Quiere desactivar el correo de turnos de suscripción?'}}"
                                       data-text-on="<p>{{'Si está habilitado, las tiendas recibirán un correo electrónico de cambio de suscripción cuando cambien correctamente su suscripción.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, las tiendas no recibirán un correo electrónico de cambio de suscripción cuando una tienda cambie exitosamente su suscripción.'}}</p>"
