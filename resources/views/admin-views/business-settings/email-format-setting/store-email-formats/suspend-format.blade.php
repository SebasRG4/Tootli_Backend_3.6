                    ...
                    <div class="card-body">
                        <div class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'Enviar correo al suspender una tienda'}}
                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si el administrador suspende una tienda, la tienda recibirá un correo de suspensión del sistema.'}}">
                                    <img src="{{ asset('assets/admin/img/info-circle.svg') }}" alt="{{ 'Enviar correo al suspender una tienda' }}">
                                </span>
                            </h5>
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                data-title-on="{{'¿Quieres habilitar la suspensión del correo de la tienda?'}}"
                                data-title-off="{{'¿Quieres desactivar el correo suspendido de la tienda?'}}"
                                data-text-on="<p>{{'Si está habilitado, la Tienda recibirá un correo electrónico para suspender la cuenta.'}}</p>"
                                data-text-off="<p>{{'Si está deshabilitada, la Tienda no recibirá un correo electrónico para suspender la cuenta.'}}</p>"
