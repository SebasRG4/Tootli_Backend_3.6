                    ...
                    <div class="card-body">
                        <div class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'Enviar correo al reactivar una tienda'}}
                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si el administrador reactiva una tienda, la tienda recibirá un correo reactivado del sistema.'}}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                data-title-on="{{'¿Quieres habilitar Almacenar correo no suspendido?'}}"
                                data-title-off="{{'¿Quiere desactivar Almacenar correo no suspendido?'}}"
                                data-text-on="<p>{{'Si está habilitado, la Tienda recibirá un correo electrónico para cancelar la suspensión de la cuenta.'}}</p>"
                                data-text-off="<p>{{'Si está deshabilitada, la Tienda no recibirá un correo electrónico para cancelar la suspensión de la cuenta.'}}</p>"
