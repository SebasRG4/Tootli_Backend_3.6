            ...
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si una tienda solicita un retiro y el administrador lo aprueba, la tienda recibirá un correo electrónico automático de aprobación de retiro del sistema.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-text-on="<p>{{'Si está habilitado, las tiendas recibirán un correo de aprobación para solicitar un retiro.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, las tiendas no recibirán ningún correo de aprobación de retiro.'}}</p>"
