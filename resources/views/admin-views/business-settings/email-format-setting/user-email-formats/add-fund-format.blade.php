                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Enviar correo sobre "Agregar fondos"?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Los clientes recibirán un correo automático del sistema cuando el administrador agregue fondos a su billetera.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                        ...
                                        data-title-on="{{'¿Quieres habilitar agregar correo de fondos?'}}"
                                        data-title-off="{{'¿Quieres desactivar el correo para agregar fondos?'}}"
                                        data-text-on="<p>{{'Si está habilitado, los clientes recibirán un correo electrónico cuando el administrador agregue fondos a su billetera.'}}</p>"
                                        data-text-off="<p>{{'Si está deshabilitado, los Clientes no recibirán un correo electrónico sobre los Fondos agregados.'}}</p>"
