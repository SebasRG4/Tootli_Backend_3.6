            ...
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si un Cliente hace clic en "Olvidé mi contraseña" durante el inicio de sesión, se enviará un correo electrónico automático con un enlace para restablecer la contraseña.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-text-on="<p>{{'Si está habilitado, el Cliente recibirá un correo electrónico automatizado con un enlace para restablecer la contraseña.'}}</p>"
