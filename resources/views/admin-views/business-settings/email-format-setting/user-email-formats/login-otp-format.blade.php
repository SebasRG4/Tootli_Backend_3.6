                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Enviar correo en \'Iniciar sesión en OTP\'?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Los clientes recibirán una OTP cada vez que inicien sesión en su cuenta a través de la aplicación del cliente o el sitio web.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="{{'¿Quiere habilitar el correo de inicio de sesión del usuario?'}}"
                                       data-title-off="{{'¿Quiere desactivar el correo de inicio de sesión del usuario?'}}"
                                       data-text-on="<p>{{'Si está habilitado, los clientes recibirán un correo electrónico OTP de inicio de sesión cada vez que inicien sesión en su cuenta.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, los clientes no recibirán ningún correo electrónico OTP durante el inicio de sesión.'}}</p>"
