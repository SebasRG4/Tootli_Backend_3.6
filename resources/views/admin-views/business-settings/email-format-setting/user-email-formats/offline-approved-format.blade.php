                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Enviar correo sobre pago fuera de línea?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si el administrador aprueba un pago fuera de línea, el usuario recibirá un correo de desaprobación automática del sistema.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="{{'¿Quiere habilitar el correo de aprobación de pagos sin conexión?'}}"
                                       data-title-off="{{'¿Quiere desactivar el correo de aprobación de pagos fuera de línea?'}}"
                                       data-text-on="<p>{{'Si está habilitado, el usuario recibirá un correo electrónico de confirmación cuando el administrador apruebe su pago fuera de línea.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, los usuarios no recibirán el correo de aprobación de pago fuera de línea.'}}</p>"
