                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Enviar correo en caso de pago fuera de línea denegado?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si el administrador rechaza un pago fuera de línea, el cliente recibirá un correo de desaprobación automática del sistema.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="{{'¿Quiere habilitar el correo de denegación de pago sin conexión?'}}"
                                       data-title-off="{{'¿Quiere desactivar el correo de denegación de pago sin conexión?'}}"
                                       data-text-on="<p>{{'Si está habilitado, los usuarios recibirán un correo electrónico de confirmación cuando el administrador rechace su pago sin conexión.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, los usuarios no recibirán un correo electrónico de rechazo de pago fuera de línea.'}}</p>"
