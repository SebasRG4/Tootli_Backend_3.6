                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Enviar correo sobre "verificación de entrega"?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Los clientes recibirán un código de verificación de entrega por correo electrónico durante la entrega. Luego, el Cliente entrega el código al Repartidor para confirmar la entrega.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="{{'¿Quiere habilitar el correo de verificación de pedidos?'}}"
                                       data-title-off="{{'¿Quiere desactivar el correo de verificación de pedidos?'}}"
                                       data-text-on="<p>{{'Si está habilitado, los clientes recibirán un código de verificación por correo durante la entrega y el repartidor podrá verificar el pedido con el código proporcionado.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, los Clientes no recibirán ningún código de verificación por correo para verificar la entrega.'}}</p>"
