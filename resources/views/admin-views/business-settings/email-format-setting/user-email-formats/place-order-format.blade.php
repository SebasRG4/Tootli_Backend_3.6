                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Enviar correo sobre "Realización de pedido"?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Los clientes recibirán un correo electrónico automatizado después de realizar un pedido con éxito.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="{{'¿Quieres habilitar el correo para realizar pedidos?'}}"
                                       data-title-off="{{'¿Quieres desactivar el correo para realizar pedidos?'}}"
                                       data-text-on="<p>{{'Si está habilitado, los clientes recibirán un correo electrónico de confirmación automática para realizar el pedido correctamente con una factura.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, los clientes NO recibirán ningún correo electrónico de realización de pedidos.'}}</p>"
