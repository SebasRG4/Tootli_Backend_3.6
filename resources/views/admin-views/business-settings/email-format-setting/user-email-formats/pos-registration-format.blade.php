                    ...
                    <div class="card-body">
                        <div class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'Recibir correo al registrarse como nuevo cliente en POS'}}
                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si un usuario se agregó a través de POS, recibirá un correo de confirmación automático con su correo electrónico y contraseña.'}}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                data-title-on="{{'¿Quieres habilitar el correo de Registro de POS de Usuario?'}}"
                                data-title-off="{{'¿Quiere desactivar el correo de registro de POS de usuario?'}}"
                                data-text-on="<p>{{'Si está habilitado, los clientes recibirán un correo electrónico de confirmación de que su registro fue exitoso y recibirán el correo electrónico y la contraseña por correo.'}}</p>"
                                data-text-off="<p>{{'Si está deshabilitado, los clientes no recibirán ningún correo electrónico de confirmación de registro.'}}</p>"
                            ...
                            <div class="email-format-wrapper">
                                ...
                                <div class="right-content">
                                    ...
                                    <div class="__bg-F8F9FC-card default-form lang_form" id="default-form">
                                        ...
                                        <div class="form-group mb-0">
                                            <label class="form-label">
                                                {{ 'Mensaje del segundo cuerpo del correo' }}({{ 'por defecto' }})
                                                <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Escriba el cuerpo del mensaje del correo en 75 palabras'}}">
                                                    <i class="tio-info-outined"></i>
                                                </span>
                                            </label>
                                    ...
                                    if($data && count($data['translations'])){
                                        ...
                                        <div class="__bg-F8F9FC-card d-none lang_form" id="{{$lang}}-form1">
                                            ...
                                            <div class="form-group mb-0">
                                               <label class="form-label">
                                                    {{ 'Mensaje del segundo cuerpo del correo' }}({{strtoupper($lang)}})
                                                    <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Escriba el cuerpo del mensaje del correo en 75 palabras'}}">
                                                        <i class="tio-info-outined"></i>
                                                    </span>
                                                </label>
                                ...
                                @else
                                    <div class="__bg-F8F9FC-card default-form">
                                        ...
                                        <div class="form-group mb-0">
                                              <label class="form-label">
                                                {{ 'Mensaje del segundo cuerpo del correo' }}
                                                 <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Escriba el cuerpo del mensaje del correo en 75 palabras'}}">
                                                        <i class="tio-info-outined"></i>
                                                    </span>
                                            </label>
                                            <textarea class="ckeditor form-control" name="body_2[]">
                                                {{ 'Credencial de su cuenta:' }},
                                            </textarea>
                                        </div>
                                    </div>
                                @endif
