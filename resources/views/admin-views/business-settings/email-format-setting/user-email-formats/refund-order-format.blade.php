                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'¿Enviar correo en pedido de reembolso?'}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Los clientes recibirán un correo electrónico automatizado cuando reciban un reembolso en su billetera por parte del administrador con los detalles del reembolso.' }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                       ...
                                       data-title-on="{{'¿Quiere habilitar el correo de pedido de reembolso?'}}"
                                       data-title-off="{{'¿Quiere desactivar el correo de pedido de reembolso?'}}"
                                       data-text-on="<p>{{'Si está habilitado, los Clientes recibirán un correo electrónico automático cuando reciban un reembolso.'}}</p>"
                                       data-text-off="<p>{{'Si está deshabilitado, los Clientes no recibirán ningún correo sobre Órdenes de Reembolso.'}}</p>"
