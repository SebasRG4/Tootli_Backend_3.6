                    ...
                    <div class="card-body">
                        <div class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'Enviar correo al suspender a un cliente'}}
                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si el administrador suspende el correo de un cliente, el cliente recibirá un correo de suspensión del sistema.'}}">
                                    <img src="{{ asset('assets/admin/img/info-circle.svg') }}" alt="{{ 'Enviar correo al suspender a un cliente' }}">
                                </span>
                            </h5>
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                data-title-on="{{'¿Quiere habilitar la suspensión del correo del cliente?'}}"
                                data-title-off="{{'¿Quiere desactivar el correo de suspensión del cliente?'}}"
                                data-text-on="<p>{{'Si está habilitado, el Cliente recibirá un correo electrónico para suspender la cuenta.'}}</p>"
                                data-text-off="<p>{{'Si está deshabilitado, el Cliente no recibirá un correo electrónico para suspender la cuenta.'}}</p>"
