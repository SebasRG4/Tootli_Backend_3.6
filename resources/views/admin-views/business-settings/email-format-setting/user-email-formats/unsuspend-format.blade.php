                    ...
                    <div class="card-body">
                        <div class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{'Enviar correo al cancelar la suspensión de un cliente'}}
                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Si el administrador reactiva el correo de un cliente, el cliente recibirá un correo suspendido del sistema.'}}">
                                    <img src="{{ asset('assets/admin/img/info-circle.svg') }}" alt="{{ 'Enviar correo al reactivar a un cliente' }}">
                                </span>
                            </h5>
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                data-title-on="{{'¿Quiere habilitar la reactivación del correo del cliente?'}}"
                                data-title-off="{{'¿Quiere deshabilitar el correo reactivado del cliente?'}}"
                                data-text-on="<p>{{'Si está habilitado, el Cliente recibirá un correo electrónico para cancelar la suspensión de la cuenta.'}}</p>"
                                data-text-off="<p>{{'Si está deshabilitado, el Cliente no recibirá un correo electrónico para cancelar la suspensión de la cuenta.'}}</p>"
