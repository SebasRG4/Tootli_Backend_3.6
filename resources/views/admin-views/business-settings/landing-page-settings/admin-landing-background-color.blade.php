    ...
    <div class="card my-2">
        <div class="card-body">
            <form action="{{ route('admin.business-settings.admin-landing-page-settings', 'background-color') }}"
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <label for="header-bg" class="form-label d-block text-center">{{ 'Color primario 1' }}</label>
                    ...
                    <div class="col-sm-6">
                        <label for="footer-bg" class="form-label d-block text-center">{{ 'Color primario 2' }}</label>
