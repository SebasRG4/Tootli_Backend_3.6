                ...
                <form class="custom-validation" data-ajax="true" id=campaign-form enctype="multipart/form-data">
                    ...
                    @if($language)
                        ...
                        <div class="lang_form" id="default-form">
                            <div class="form-group error-wrapper">
                                ...
                                <input type="text" name="title[]" id="default_title" class="form-control" placeholder="{{'nueva campaña'}}" value="{{$campaign?->getRawOriginal('title')}}" required>
                            </div>
                        ...
                        @foreach(json_decode($language) as $lang)
                            ...
                            <div class="d-none lang_form" id="{{$lang}}-form">
                                <div class="form-group error-wrapper">
                                    ...
                                    <input type="text" name="title[]" id="{{$lang}}_title" class="form-control" placeholder="{{'nueva campaña'}}" value="{{$translate[$lang]['title']??''}}">
                                </div>
                    ...
                    <div id="default-form">
                        <div class="form-group error-wrapper">
                            ...
                            <input type="text" name="title[]" class="form-control" placeholder="{{'nueva campaña'}}" value="{{$campaign['title']}}" maxlength="100">
                        </div>
