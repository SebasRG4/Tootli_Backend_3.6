                ...
                <form enctype="multipart/form-data" class="custom-validation" data-ajax="true" id="campaign-form">
                    ...
                    @if($language)
                        ...
                        <div class="lang_form" id="default-form">
                            <div class="form-group error-wrapper">
                                ...
                                <input type="text" name="title[]" id="default_title" class="form-control" placeholder="{{'nueva campaña'}}"  required>
                            </div>
                        ...
                        @foreach(json_decode($language) as $lang)
                            <div class="d-none lang_form" id="{{$lang}}-form">
                                <div class="form-group error-wrapper">
                                    ...
                                    <input type="text" name="title[]" id="{{$lang}}_title" class="form-control" placeholder="{{'nueva campaña'}}"  >
                                </div>
                    ...
                    <div id="default-form">
                        <div class="form-group error-wrapper">
                            ...
                            <input type="text" name="title[]" class="form-control" placeholder="{{'comida nueva'}}">
                        </div>
                            ...
                            <div class="row g-3">
                                {{-- <div class="col-sm-12">
                                    <div>
                                        ...
                                        <select name="module_id" id="module_id" required class="form-control js-select2-custom"  data-placeholder="{{'seleccionar módulo'}}" id="module_select">
                                            <option value="" selected disabled>{{'seleccionar módulo'}}</option>
                                            @foreach(\App\Models\Module::notParcel()->get() as $module)
                                                <option value="{{$module->id}}">{{$module->module_name}}</option>
                                            @endforeach
                                        </select>
                                        <small class="text-danger">{{'advertencia de cambio de módulo'}}</small>
                                    </div>
                                </div> --}}
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="error-wrapper">
                                        <label class="input-label text-capitalize" for="title">{{'hora de inicio diaria'}}</label>
                                        <input type="time" id="start_time" class="form-control" name="start_time">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="error-wrapper">
                                        <label class="input-label text-capitalize" for="title">{{'hora de finalización diaria'}}</label>
