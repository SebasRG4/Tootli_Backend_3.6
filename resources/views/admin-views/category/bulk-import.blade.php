...
@section('title','categoría importación masiva')
            ...
            <div class="card-body">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="export-steps-item-2 h-100">
                                ...
                                <ul class="m-0 pl-4">
                                    ...
                                    <li>
                                        {{ 'Para la categoría principal, la "posición" será 0 y para la subcategoría será 1'}}
                                    </li>
                                    <li>
                                        {{ 'Por defecto el estado será 1, ingrese los ID correctos' }}
                                    </li>
                                    <li>
                                        {{ 'Para una categoría, la identificación principal estará vacía, para la subcategoría será la identificación de la categoría.' }}
                                    </li>
                                    <li>
                                        {{ 'Para una identificación de módulo de subcategoría, será la identificación del módulo principal.' }}
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="export-steps-item-2 h-100">
                                ...
                                <ul class="m-0 pl-4">
                                    <li>
                                     ...
                                     <li>
                                        {{ 'Puede cargar las imágenes de su categoría en la carpeta de categorías desde la galería y copiar la ruta de la imagen.' }}
                                     </li>
                ...
                <div class="text-center pb-4">
                    ...
                    <div class="btn--container justify-content-center export--template-btns">
                        ...
                        <a href="{{asset('assets/categories_bulk_format.xlsx')}}" download="" class="btn btn--primary btn-outline-primary">{{ 'Plantilla con datos existentes' }}</a>
                        <a href="{{asset('assets/categories_bulk_without_data_format.xlsx')}}" download="" class="btn btn--primary">{{ 'Plantilla sin datos' }}</a>
                ...
                <div class="card mt-2 rest-part">
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-sm-6">
                                <h5 class="text-capitalize mb-3">{{ 'Importar archivo de categoría' }}</h5>
