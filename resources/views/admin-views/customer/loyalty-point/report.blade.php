...
@section('title','informe de puntos de fidelidad del cliente')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title mr-3">
                ...
                <span>
                     {{'informe de puntos de fidelidad del cliente'}}
                </span>
            </h1>
        </div>
        <!-- Page Header -->
                    ...
                    <div class="row justify-content-end align-items-end g-3">
                        <div class="col-lg-4">
                            ...
                            <select name="transaction_type" id="add-fund-type"
                                ...
                                <option
                                    value="point_to_wallet" {{isset($transaction_status) && $transaction_status=='point_to_wallet'?'selected':''}}>{{'apuntar a la billetera'}}</option>
                                <option
                ...
                <div class="table-responsive">
                    <table id="datatable"
                        ...
                        <tr>
                            ...
                            <th class="border-0">{{'puntos ganados'}}</th>
                            <th class="border-0">{{'puntos convertidos'}}</th>
                            <th class="border-0">{{'puntos actuales en la billetera'}}</th>
