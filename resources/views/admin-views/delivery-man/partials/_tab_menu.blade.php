    ...
    <ul class="nav nav-tabs nav--pills mb-3 border-0 nav--tabs">
        <li class="nav-item">
            <a class="nav-link {{request()?->tab == 'info' ||  !request()?->tab ? 'active' : ''}}"
                ...
                aria-disabled="true">{{ 'información' }}</a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{request()?->tab == 'transaction' ? 'active' : ''}}"
                ...
                aria-disabled="true">{{ 'transacción' }}</a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{request()?->tab == 'order_list' ? 'active' : ''}}"
                ...
                aria-disabled="true">{{ 'lista de pedidos' }}</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link {{request()?->tab == 'loyalty-point' ? 'active' : ''}}"
                ...
                aria-disabled="true">{{ 'Puntos de fidelidad' }}</a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{request()?->tab == 'referal-earn' ? 'active' : ''}}"
                ...
                aria-disabled="true">{{ 'Recomiende y gane' }}</a>
        </li>
        @endif
    </ul>
    <!-- End Nav -->
