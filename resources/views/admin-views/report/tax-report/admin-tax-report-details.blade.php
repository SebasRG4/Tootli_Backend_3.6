                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="bg-white p-12 w-100 rounded d-flex align-items-center justify-content-between">
                            {{ 'Órdenes totales' }} <h4 class="theme-clr fw-bold mb-0">{{ $total_count }}
                            </h4>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="bg-white p-12 w-100 rounded d-flex align-items-center justify-content-between">
                            {{ 'Monto total del pedido' }} <h4 class="theme-clr fw-bold mb-0">
                    ...
                    <div class="col-md-6">
                        <div class="bg-white p-12 w-100 rounded d-flex align-items-center justify-content-between">
                            {{ 'Comisión total' }} <h4 class="cus-warning-light-clr fw-bold mb-0">
