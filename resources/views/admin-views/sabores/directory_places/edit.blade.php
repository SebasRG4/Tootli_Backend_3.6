                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sabores_map_emoji" value="{{$place->sabores_map_emoji}}" class="form-control" placeholder="Ej. 🌳 o 🍷" maxlength="5">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                            ...
                            <div class="map-for-vndor map_custom-controls position-relative">
                                ...
                                <div class="d-flex bg-white align-items-center gap-1 laglng-controller mt-2 p-2 rounded">
                                    <div id="latlng" class="d-flex">
                                        <input type="text" id="latitude" name="latitude" value="{{$place->latitude}}" class="border-0 p-0 m-0 text-center outline-0" placeholder="Latitud" required readonly>
                                        <span class="text-gray1">|</span>
                                        <input type="text" name="longitude" value="{{$place->longitude}}" class="border-0 p-0 m-0 text-center outline-0" placeholder="Longitud" id="longitude" required readonly>
                                    </div>
                                </div>
...
@push('script_2')
    <script>
        window.mapConfig = {
            oldLat: parseFloat("{{ $place->latitude ?? 23.757989 }}"),
            oldLng: parseFloat("{{ $place->longitude ?? 90.360587 }}"),
            oldZoneId: "{{ $place->zone_id }}",
            oldAddress: "",
            translations: {
