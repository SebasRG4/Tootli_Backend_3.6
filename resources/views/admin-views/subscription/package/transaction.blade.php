    ...
    <div class="content container-fluid">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal mb-4">
            <ul class="nav nav-tabs border-0 nav--tabs nav--pills">
                <li class="nav-item">
                    <a href="{{ route('admin.business-settings.subscriptionackage.show',$id) }}" class="nav-link">{{ 'Detalles del paquete' }}</a>
                </li>
                <li class="nav-item">
                ...
                <div class="search--button-wrapper justify-content-end">
                    ...
                    <form class="search-form">
                        <div class="input-group input--group">
                            <input name="search" type="search" value="{{ request()?->search }}" class="form-control h--40px" placeholder="{{ 'Ej: buscar por ID o nombre de tienda' }}" aria-label="Search here">
