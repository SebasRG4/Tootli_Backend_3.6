...
<div class="content container-fluid">
    ...
    <div class="card py-3 px-xxl-4 px-3 mb-20">
        <div class="d-flex flex-sm-nowrap flex-wrap gap-3 align-items-center justify-content-between">
            <div class="">
                <h3 class="mb-1">{{ 'Sección de descarga de la aplicación Deliveryman' }}</h3>
                <p class="mb-0 gray-dark fs-12">
                    {{ 'Vea cómo verán los clientes la sección de descarga de la aplicación Deliveryman.' }}
                </p>
            </div>
    ...
    <div class="card mb-20">
        <form action="#0">
            <div class="card-body">
                <div class="mb-20">
                    <h3 class="mb-1">{{ 'Contenido de la sección de descarga de la aplicación Deliveryman' }}</h3>
                                ...
                                <div class="col-md-12 lang_form default-form">
                                    <div class="row g-1">
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <textarea type="text" name="available_zone_short_description[]" placeholder="{{'subtitular'}}" class="form-control min-h-90px ckeditor"></textarea>
                                        </div>
                                        <div class="col-12">
                                            ...
                                            <input id="download_button_name" type="text"  maxlength="20" name="download_button_name[]" value="{{ $download_user_app_sub_title?->getRawOriginal('value')??'' }}" class="form-control" placeholder="{{'Inicio de venta...'}}">
                    ...
                    <div class="col-lg-4">
                        <div class="bg--secondary h-100 rounded p-md-4 p-3 d-center">
                            <div class="text-center">
                                <div class="mb-4">
                                    <h5 class="mb-1">{{ 'Cargar imagen de sección de zona' }}</h5>
                                    <p class="mb-0 fs-12 gray-dark">{{ 'Sube la imagen de tu sección de zona' }}</p>
                                </div>
        ...
        <div class="tab-pane fade show active">
            ...
            <form action="{{ route('admin.business-settings.react-landing-page-settings', 'download-app-section') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-20">
                            <h3 class="mb-1">{{ 'Botón de sección de descarga de la aplicación Deliveryman' }}</h3>
                            <p class="mb-0 fs-12">{{ 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam odio tellus, laoreet' }}</p>
                        </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="hidden" name="lang[]" value="default">
                                        ...
                                        <div class="col-md-12 d-none lang_form" id="{{$lang}}-form1">
                                            <div class="row g-1">
                                                <div class="col-12">
                                                    <label for="download_user_app_title{{$lang}}" class="form-label">{{'Título'}} ({{strtoupper($lang)}})<span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Escribe el título dentro de 100 caracteres.' }}">
                                                    <i class="tio-info color-A7A7A7"></i>
                                                </span></label>
                                        ...
                                        <span class="text-right text-counting color-A7A7A7 d-block mt-1">0/100</span>
                                                ...
                                                <div class="col-12">
                                                    <label for="download_user_app_sub_title{{$lang}}" class="form-label">{{'Subtítulo'}} ({{strtoupper($lang)}})<span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Escribe el título dentro de 200 caracteres.' }}">
                                                    <i class="tio-info color-A7A7A7"></i>
                                                </span></label>
    ...
    <form action="{{ route('taxvat.store') }}" method="post">
        <div>
            <div class="custom-offcanvas-header bg--secondary d-flex justify-content-between align-items-center px-3 py-3">
                <div class="py-1">
                    <h3 class="mb-0 line--limit-1">{{ 'Vista previa de la sección de descarga de la aplicación Deliveryman' }}</h3>
                </div>
                        ...
                        <div>
                            <div class="bg-white py-3 px-sm-5 px-1 rounded-10">
                                <div class="mb-20 text-center">
                                    <h3 class="mb-1">{{ 'Descargue la aplicación del controlador' }}</h3>
                                    <p class="mb-0 fs-12">{{ 'Toma el control de tus viajes a cualquier lugar.' }}</p>
                                </div>
