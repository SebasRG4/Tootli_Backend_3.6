            ...
            <div class="bg--secondary h-100 rounded p-md-4 p-3 mb-20">
                ...
                <div class="row g-1 lang_form default-form">
                    <div class="col-sm-12">
                        ...
                        <textarea id="" type="text"  maxlength="100" name="[]" class="form-control min-h-45px" value="" rows="1" placeholder="{{'título aquí...'}}"></textarea>
                                    ...
                                    <div class="bg--secondary h-100 rounded p-4">
                                        <div class="text-center py-1">                            
                                            ...
                                            <p class="fs-10 text-center mb-0 mt-lg-4 mt-3">
                                                <span class="font-medium color-656566">{{ 'Relación (1:1)'}}</span>
                                            </p>
                                        </div>
                                    </div>                            
                                </div>
