...
<div class="content container-fluid">
    ...
    <div class="card py-3 px-xxl-4 px-3 mb-20">
        <div class="d-flex flex-sm-nowrap flex-wrap gap-3 align-items-center justify-content-between">
            <div class="">
                <h3 class="mb-1">{{ 'Sección de descarga de la aplicación del vendedor' }}</h3>
                <p class="mb-0 gray-dark fs-12">
                    {{ 'Vea cómo verán los clientes la sección de descarga de su aplicación de vendedor.' }}
                </p>
            </div>
    ...
    <div class="card mb-20">
        <form action="#0">
            <div class="card-body">
                <div class="mb-20">
                    <h3 class="mb-1">{{ 'Contenido de la sección de descarga de la aplicación del vendedor' }}</h3>
                    <p class="mb-0 fs-12">{{ 'Administre su negocio mientras viaja con la aplicación del vendedor.' }}</p>
                </div>
                <div class="row g-3">
                    <div class="col-lg-8">
                                    ...
                                    <div class="row g-1">
                                        <div class="col-12">
                                            <label for="download_user_app_title" class="form-label">{{'Título'}} ({{ 'por defecto' }})
                                                <span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Escribe el título dentro de 100 caracteres.' }}">
                                            ...
                                            <input id="download_user_app_title" type="text"  maxlength="100" name="download_user_app_title[]" value="{{ $download_user_app_title?->getRawOriginal('value')??'' }}" class="form-control" placeholder="{{'título aquí...'}}">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input id="download_user_app_sub_title" type="text"  maxlength="200" name="download_user_app_sub_title[]" value="{{ $download_user_app_sub_title?->getRawOriginal('value')??'' }}" class="form-control" placeholder="{{'subtítulo aquí...'}}">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input id="download_button_name" type="text"  maxlength="20" name="download_button_name[]" value="{{ $download_user_app_sub_title?->getRawOriginal('value')??'' }}" class="form-control" placeholder="{{'subtítulo aquí...'}}">
                        ...
                        <div class="bg--secondary h-100 rounded p-md-4 p-3 d-center">
                            <div class="text-center">
                                <div class="mb-4">
                                    ...
                                    <p class="mb-0 fs-12 gray-dark">{{ 'Cargue la imagen de la sección de descarga de su aplicación de vendedor' }}</p>
                                </div>
    ...
    <div class="card shadow-none border-0 bg-opacity-primary-10 mb-20">
        <div class="card-body py-3 d-flex gap-2 align-items-center">
            ...
            <p class="fs-12 color-656566 m-0">
                {{ 'Nuestros 12 socios populares se mostrarán automáticamente en la página de inicio del administrador, según su popularidad.' }}
            </p>
        </div>
    </div>
        ...
        <div class="tab-pane fade show active">
            ...
            <form action="{{ route('admin.business-settings.react-landing-page-settings', 'download-app-section') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-20">
                            <h3 class="mb-1">{{ 'Botón de la sección de descarga de la aplicación del vendedor' }}</h3>
                            <p class="mb-0 fs-12">{{ 'Administre rápidamente la descarga y acceda a la aplicación para una experiencia de vendedor perfecta.' }}</p>
                        </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="lang_form default-form">
                                        <div class="row g-1">
                                            <div class="col-12">
                                                <label for="download_user_app_title" class="form-label">{{'Título'}} ({{ 'por defecto' }})
                                                <span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Escribe el título dentro de 60 caracteres.' }}">
                                                    <i class="tio-info color-A7A7A7"></i>
                                                </span><span class="form-label-secondary text-danger"
                                                data-toggle="tooltip" data-placement="right"
                                                data-original-title="{{ 'Requerido.'}}"> *
                                        ...
                                        <span class="text-right text-counting color-A7A7A7 d-block mt-1">0/100</span>
                                            ...
                                            <div class="col-12">
                                                <label for="download_user_app_sub_title" class="form-label">{{'Subtítulo'}} ({{ 'por defecto' }})
                                                <span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Escribe el título dentro de 180 caracteres.' }}">
                                                    <i class="tio-info color-A7A7A7"></i>
                                                </span><span class="form-label-secondary text-danger"
                                                data-toggle="tooltip" data-placement="right"
                                                data-original-title="{{ 'Requerido.'}}"> *
                                    ...
                                    <input type="hidden" name="lang[]" value="default">
                                        ...
                                        <div class="col-md-12 d-none lang_form" id="{{$lang}}-form1">
                                            <div class="row g-1">
                                                <div class="col-12">
                                                    <label for="download_user_app_title{{$lang}}" class="form-label">{{'Título'}} ({{strtoupper($lang)}})<span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Escribe el título dentro de 60 caracteres.' }}">
                                                    <i class="tio-info color-A7A7A7"></i>
                                                </span></label>
                                        <input id="download_user_app_title{{$lang}}" type="text"  maxlength="100" name="download_user_app_title[]" value="{{ $download_user_app_title_translate[$lang]['value']??'' }}" class="form-control" placeholder="{{'título aquí...'}}">
                                        <span class="text-right text-counting color-A7A7A7 d-block mt-1">0/100</span>
                                                </div>
                                                <div class="col-12">
                                                    <label for="download_user_app_sub_title{{$lang}}" class="form-label">{{'Subtítulo'}} ({{strtoupper($lang)}})<span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Escribe el título dentro de 180 caracteres.' }}">
                                                    <i class="tio-info color-A7A7A7"></i>
                                                </span></label>
                                        <input type="text" id="download_user_app_sub_title{{$lang}}" maxlength="200" name="download_user_app_sub_title[]" value="{{ $download_user_app_sub_title_translate[$lang]['value']??'' }}" class="form-control" placeholder="{{'subtítulo aquí...'}}">
                                        <span class="text-right text-counting color-A7A7A7 d-block mt-1">0/200</span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row g-1">
                                            <div class="col-12">
                                                <label for="download_user_app_title" class="form-label">{{'Título'}}</label>
                                                <input type="text" id="download_user_app_title" name="download_user_app_title[]" class="form-control" placeholder="{{'título aquí...'}}">
                                            </div>
                                            <div class="col-12">
                                                <label for="download_user_app_sub_title" class="form-label">{{'Subtítulo'}}</label>
                                                <input id="download_user_app_sub_title" type="text" name="download_user_app_sub_title[]" class="form-control" placeholder="{{'subtítulo aquí...'}}">
                                            </div>
                                        </div>
                                    </div>
                                        <input type="hidden" name="lang[]" value="default">
                                            ...
                                            <div class="form-group mb-md-0">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    <label for="playstore_url" class="form-label text-capitalize m-0">
                                                        {{'Enlace de descarga'}}
                                                        <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Cuando esté deshabilitado, el botón de descarga de Play Store estará oculto en la página de inicio de React.' }}">
                                                            <i class="tio-info color-A7A7A7"></i>
                                                        </span>
                                                    </label>
                                                </div>
                                                <input type="url" {{(isset($download_user_app_links) && $download_user_app_links['playstore_url_status'])?'required':''}} id="playstore_url" placeholder="{{'Ej: https://play.google.com/store/apps'}}" class="form-control h--45px" name="playstore_url" value="{{ $download_user_app_links['playstore_url']??''}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="form-group mb-md-0">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    <label for="apple_store_url" class="form-label text-capitalize m-0">
                                                        {{'Enlace de descarga'}}
                                                        <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="{{ 'Cuando esté deshabilitado, el botón de descarga de la aplicación del usuario se ocultará en la página de inicio de React.' }}">
                                                            <i class="tio-info color-A7A7A7"></i>
                                                        </span>
                                                    </label>
                                                </div>
                                                <input type="url" id="apple_store_url" {{(isset($download_user_app_links) && $download_user_app_links['apple_store_url_status'])?'required':''}} placeholder="{{'Ejemplo: https://www.apple.com/app-store/'}}" class="form-control h--45px" name="apple_store_url" value="{{ $download_user_app_links['apple_store_url']??''}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <form action="{{ route('taxvat.store') }}" method="post">
        <div>
            <div class="custom-offcanvas-header bg--secondary d-flex justify-content-between align-items-center px-3 py-3">
                <div class="py-1">
                    <h3 class="mb-0 line--limit-1">{{ 'Vista previa de la sección de descarga de la aplicación del vendedor' }}</h3>
                </div>
                        ...
                        <div>
                            <div class="__bg-FAFAFA rounded-10 px-xl-3 px-1 py-3 d-flex flex-xl-nowrap flex-wrap justify-content-xl-start justify-content-center align-items-center gap-x-xl-20">
                                <div class="scan-wrap bg-white max-w-138 rounded px-xl-2 px-1 py-3 mb-xl-0 mb-3 w-xl-auto w-100">
                                    ...
                                    <p class="mb-0 fs-12 mt-1 text-center">{{ 'Escanear para descargar' }}</p>
                                </div>
                                <div>
                                    <div class="mb-3 text-xl-start text-center">
                                        <h4 class="mb-0">{{ 'Descarga la aplicación del vendedor' }}</h4>
                                        <p class="mb-0 fs-12">{{ 'Mantén el control, estés donde estés.' }}</p>
                                    </div>
