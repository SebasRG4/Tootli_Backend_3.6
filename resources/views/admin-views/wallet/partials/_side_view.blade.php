...
<label class="badge badge-soft-primary mb-0">{{'Pendiente'}}</label>
@else
...
<div class="card mb-3">
    <div class="card-header">
        <h6 class="mb-0 font-medium">{{'información de la tienda'}}</h6>
    </div>
    <div class="card-body">
...
<div class="card mb-3">
    <div class="card-header">
        <h6 class="mb-0 font-medium">{{'información del propietario'}}</h6>
    </div>
    <div class="card-body">
        <div class="key-val-list d-flex flex-column gap-2" style="--min-width: 60px">
            <div class="key-val-list-item d-flex gap-3">
...
<div class="card mb-3">
    ...
    <div class="">
        ...
        <h5 class="font-medium">{{'Nota de denegación'}}</h5>
        <div class="rounded bg-light p-3">
            {{str_replace('_' ,' ' ,$withdraw->transaction_note)}}
        </div>
    </div>
    ...
    <div class="mt-4 d-flex justify-content-center gap-3">
        <button type="button" data-id="{{$withdraw->id}}" class="btn btn-soft-danger withdraw-info-hide min-w-100px show-deny-view">{{'denegar'}}</button>
        <button type="button" data-id="{{$withdraw->id}}" class="btn btn-success withdraw-info-hide min-w-100px show-approve-view">{{'aprobar'}}</button>
    </div>
    @endif
