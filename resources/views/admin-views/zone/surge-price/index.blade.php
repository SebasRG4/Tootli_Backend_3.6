...
@section('title','Agregar precio de aumento')
...
<div class="content container-fluid">
    ...
    <h3 class="mb-20">{{'Crear nuevo precio de aumento' }}</h3>
                                    ...
                                    <div class="bg-white p-sm-3 d-flex flex-column gap-3">
                                        <div>
                                            ...
                                            <div class="position-relative date-range__custom">
                                                ...
                                                <input autocomplete="off" type="text" class="form-control h-45 position-relative bg-transparent no-type"  name="daily_date_range" placeholder="{{ 'Seleccionar fecha' }}">
                                            </div>
                                        </div>
                                        <div class="time-range-wrapper">
                                            ...
                                            <div class="position-relative cursor-pointer">
                                                <i class="tio-time icon-absolute-on-right"></i>
                                                 <input autocomplete="off" type="text" class="form-control h-45 position-relative bg-transparent time-range-picker no-type" name="daily_time_range" placeholder="{{ 'Seleccionar hora' }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                 ...
                                 <div class="shedule_item">
                                     <div class="bg-white p-sm-3 d-flex flex-column gap-3">
                                         <div class="cursor-pointer" data-toggle="modal" data-target="#weeklySelectDays_btn">
                                             ...
                                             <div class="position-relative date-range__custom">
                                                 ...
                                                 <input autocomplete="off" type="text" class="form-control h-45 position-relative bg-transparent date-range-input-demo no-type"
                                                     name="weekly_date_range" placeholder="{{ 'Seleccionar fecha' }}">
                                             </div>
                                         </div>
                                         ...
                                         <div class="time-range-wrapper">
                                             ...
                                             <div class="position-relative cursor-pointer">
                                                 <i class="tio-time icon-absolute-on-right"></i>
                                                  <input autocomplete="off" type="text" class="form-control h-45 position-relative bg-transparent time-range-picker no-type" name="weekly_time_range" placeholder="{{ 'Seleccionar hora' }}">
                                             </div>
                                         </div>
                                     ...
                                     <div class="bg-white p-sm-3 d-flex flex-column gap-3">
                                         <div class="cursor-pointer" data-toggle="modal" data-target="#surgeCustom_sheduleBtn">
                                             ...
                                             <div class="position-relative">
                                                 <i class="tio-calendar-month icon-absolute-on-right"></i>
                                                 <input autocomplete="off" type="text" id="custom_schedule_input" class="form-control h-45 position-relative bg-transparent no-type" name="" placeholder="{{ 'Seleccionar fecha y hora' }}">
                                             </div>
                                         </div>
        ...
        <div class="modal-body-inner">
            ...
            <div class="bg-light rounded p-3">
                ...
                <div class="mb-20">
                    ...
                    <div class="position-relative date-range__custom">
                        <i class="tio-calendar-month icon-absolute-on-right"></i>
                        <input autocomplete="off" type="text" class="form-control h-45 position-relative no-type" id="weekly_modal_date"  name="dates" placeholder="{{ 'Seleccionar fecha' }}">
                    </div>
                </div>
                <label class="form-check form--check mr-2 mr-md-4">
