            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/order') ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{ Request::is('admin/order/strike-review-queue*') ? 'active' : '' }}">
                                    @php
                                        $pendingStrikeReviewsEcommerce = 0;
                                        try {
                                            $pendingStrikeReviewsEcommerce = \App\Models\OrderStrikeReviewQueue::query()
                    ...
                    @if(
                        ...
                        <!-- Dynamic Sections -->
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/dynamic-section*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.dynamic-section.add-new') }}"
                                title="{{ translate('Dynamic Sections') }}">
                                <i class="tio-tab-outlined nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                        ...
                        <!-- Dynamic Sections Ecommerce -->
                        <li class="nav-item {{ Request::is('admin/dynamic-section-ecommerce*') ? 'active' : '' }}">
                            <a class="nav-link {{ Request::is('admin/dynamic-section-ecommerce*') ? 'active' : '' }}"
                                href="{{ route('admin.dynamic-section-ecommerce.index') }}"
                                title="{{ translate('Dynamic Section Shop') }}">
                                <i class="tio-layers-outlined nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    {{ translate('Dynamic Section Shop') }}
                                </span>
                            </a>
                        </li>
                        <!-- End Dynamic Sections Ecommerce -->
                    @endif
                    ...
                    @if(
                        ...
                        @if (\App\CentralLogics\Helpers::module_permission_check('category'))
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/category*') ? 'active' : '' }}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item   @yield('main_category') {{ request()->input('position') == 0 && Request::is('admin/category/add') ? 'active' : '' }}">
                        ...
                        @if (\App\CentralLogics\Helpers::module_permission_check('item'))
                            <li
                                class="navbar-vertical-aside-has-menu  @yield('low_stock_list') {{ Request::is('admin/item*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
