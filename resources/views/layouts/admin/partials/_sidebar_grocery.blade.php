                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/order') ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{ Request::is('admin/order/strike-review-queue*') ? 'active' : '' }}">
                                    @php
                                        $pendingStrikeReviewsGrocery = 0;
                                        try {
                                            $pendingStrikeReviewsGrocery = \App\Models\OrderStrikeReviewQueue::query()
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('banner'))
                        ...
                        <li
                            ...
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                ...
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ 'secciones dinámicas' }}</span>
                            </a>
                        </li>
                        <li
                            ...
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                ...
                                title="{{ 'secciones de la pantalla de inicio' }}">
                                <i class="tio-reorder nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ 'secciones de la pantalla de inicio' }}</span>
                            </a>
                        </li>
                    @endif
                    <!-- End Banner -->
