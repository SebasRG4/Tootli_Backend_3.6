...
@section('title', request()->product_gellary == 1 ? 'Agregar artículo' : 'Actualizar elemento')
                        ...
                        <div class="card-body d-flex flex-column">
                            <div class="mb-auto">
                                ...
                                <label class="input-label"
                                    for="exampleFormControlInput1">{{ 'Imágenes de elementos' }}</label>
                            ...
                            <div class="mt-3 error-wrapper">
                                <label class="text-dark">{{ 'miniatura del elemento' }} <small
