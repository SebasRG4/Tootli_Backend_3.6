...
Route::group(['namespace' => 'Api\V1', 'middleware' => 'localization'], function () {
    ...
    Route::group(['prefix' => 'admin', 'namespace' => 'Admin'], function () {
        ...
        Route::get('dashboard/urgent-refunds',  'AdminDashboardController@urgentRefunds');
    ...
    Route::post('interest/track', 'InterestController@track');
    ...
    Route::group(['prefix' => 'delivery-man', 'middleware' => 'actch:deliveryman_app'], function () {
        ...
        Route::group(['middleware' => ['dm.api', 'dm.pending_revision_gate']], function () {
            ...
            Route::post('report-deposit', 'DeliverymanController@report_deposit');
            Route::get('get-cash-in-hand', 'DeliverymanController@get_cash_in_hand');
            ...
            Route::get('cancel-reasons', 'DeliverymanController@get_delivery_cancel_reasons');
    ...
    Route::group(['middleware' => ['module-check']], function () {
        ...
        Route::group(['prefix' => 'customer', 'middleware' => 'apiGuestCheck'], function () {
            ...
            Route::group(['prefix' => 'order'], function () {
                ...
                Route::get('grouped-details', 'OrderController@get_grouped_orders');
    ...
    Route::group(['prefix' => 'service-jobs', 'middleware' => 'auth:api'], function () {
        ...
        Route::post('{job_id}/dispute/resolve', 'ServiceJobController@resolveDispute');
    });
    ...
    Route::group(['prefix' => 'protected-transactions', 'middleware' => 'auth:api'], function () {
        ...
        Route::post('{id}/dispute', 'ProtectedTransactionController@dispute');
        Route::get('{id}/dispute', 'ProtectedTransactionController@getDispute');
        Route::post('{id}/dispute/cancel', 'ProtectedTransactionController@cancelDispute');
        Route::post('{id}/dispute/resolve', 'ProtectedTransactionController@resolveDispute');
    });
});
